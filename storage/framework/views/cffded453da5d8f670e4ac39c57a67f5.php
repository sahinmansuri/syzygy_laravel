    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left"><?php echo app('translator')->get('mpcs::lang.f21_form'); ?></h4>
        ...
        <div class="col-md-12">
            <div class="settlement_tabs">
               <ul class="nav nav-tabs">
                    <!-- <?php if(auth()->check() && auth()->user()->can('f16a_form')): ?>
                    <li class="active">
                    ...
                    <li class="active">
                        <a href="#16A_form_tab" class="16A_form_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.f21_form'); ?></strong>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if(auth()->check() && auth()->user()->can('f16a_form')): ?>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="16A_form_tab">
                        <?php echo $__env->make('mpcs::forms.21Form.21_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endif; ?>
                    <?php if(auth()->check() && auth()->user()->can('16a_form')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/Modules/MPCS/Providers/../Resources/views/forms/21Form/F21.blade.php ENDPATH**/ ?>