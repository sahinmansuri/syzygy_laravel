...
<div class="row payment-row">
	...
	<div class="<?php echo e($col_class, false); ?> hide  account_module">
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<?php if(isset($view_page) || isset($edit_page)): ?>
					...
					<?php echo Form::select("payment[$row_index][account_id]", [], !empty($data[0]->related_account_id) ? $data[0]->related_account_id : (!empty($data[0]->t_account_id)? $data[0]->t_account_id : ''), ['class' =>
	...
	<?php echo $__env->make('sale_pos.partials.payment_type_details_expense', ['payment' => $payment,'edit' => !empty($edit) ? 'true' : ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</script><?php /**PATH /home/vimi31/public_html/resources/views/sale_pos/partials/payment_row_form_expense.blade.php ENDPATH**/ ?>