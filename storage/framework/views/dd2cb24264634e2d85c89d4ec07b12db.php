<div class="pos-tab-content">
     <div class="row">
		...
		<div class="col-sm-4">
            <div class="form-group">
                <?php echo Form::label('captch_site_key','reCAPTCHA Site Key'); ?>

                <?php echo Form::text('common_settings[captch_site_key]',!empty($common_settings['captch_site_key']) ? $common_settings['captch_site_key'] : null , 
                    ['class' => 'form-control', 'style' => 'width: 100%;']); ?>

            </div>
        </div>
    </div>
</div><?php /**PATH /home/vimi31/public_html/resources/views/business/partials/settings_system.blade.php ENDPATH**/ ?>