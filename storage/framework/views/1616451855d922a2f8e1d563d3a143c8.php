      ...
      <div class="col-md-3 pull-right">
        <div class="form-group">
            <select class="form-control" style="background-color: #5C2AAE;color: #ffffff;width: 100%;" id="location_id">
                <?php $__currentLoopData = $business_locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $bl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($key, false); ?>"><?php echo e($bl, false); ?></option>
      ...
      <div class="col-sm-6">
          ...
          <div class="row">
              ...
              <div class="col-sm-4" style="color:#fff; background-color: #311B92">
                  ...
                  <?php if(auth()->user()->can('DashboardSummaryCards')): ?><h5 id="purchases">0.0</h5> <?php endif; ?>
              </div>
              <div class="col-sm-4 " style="margin-left: 20px;background-color: #2E7D32;color: #fff">
                  <h5><strong>Sales</strong></h5>
                  <?php if(auth()->user()->can('DashboardSummaryCards')): ?><h5 id="sales">0.0</h5> <?php endif; ?>
              </div>
          </div>
          ...
          <div class="row" style="margin-top: 20px">
              ...
              <div class="col-sm-4" style="color: #fff; background-color:#B56101">
                  ...
                  <?php if(auth()->user()->can('DashboardSummaryCards')): ?><h5 id="stocks">0.0</h5> <?php endif; ?>
              </div>
              <div class="col-sm-4 " style="margin-left: 20px; color: white;
              background-color: #D32F2F">
                  <h5><strong>Expenses</strong></h5>
                  <?php if(auth()->user()->can('DashboardSummaryCards')): ?><h5 id="expenses">0.0</h5> <?php endif; ?>
              </div>
          </div>
          ...
          <div class="row" style="margin-top: 20px">
              ...
              <div class="col-sm-4" style="color:#fff; background-color: #00a3e8">
                  ...
                  <?php if(auth()->user()->can('DashboardSummaryCards')): ?><h5 id="credit_given">0.0</h5> <?php endif; ?>
              </div>
              <div class="col-sm-4 bg-primary " style="margin-left: 20px; color: #fff;background-color: #dcb612">
                  ...
                  <?php if(auth()->user()->can('DashboardSummaryCards')): ?><h5 id="credit_received" >0.0</h5> <?php endif; ?>
              </div>
          </div>
...
<?php if(!auth()->user()->can('DashboardPaymentMethods')): ?>
    <script>
...
<?php if(!auth()->user()->can('DashboardProductCategories')): ?>
    <script>
        productsColors = ["#B56101","#B56101","#B56101","#B56101"];
    </script>
<?php endif; ?>

<?php if(!auth()->user()->can('DashboardGlance')): ?>
    <script>
        glanceDenied = true;
    </script>
<?php endif; ?>

<?php if(!auth()->user()->can('DashboardCurrentPastGraph')): ?>
    <script>
        layeredDenied = true;
    </script>
<?php endif; ?>

<?php if(!auth()->user()->can('DashboardCurrentPastPayments')): ?>
    <script>
...
<script>
    ...
    function loadData(option){
        ...
        var loading = "<span>Loading...</span>";
            ...
            $.ajax({
              url: "<?php echo e(action('HomeController@index'), false); ?>" , 
              type: 'GET', 
...
<?php if(!empty($customer_name_payment)): ?>
<script>
  swal({
      title: 'Payment Received',
      text: 'Pending direct payment is Done by <?php echo e($customer_name_payment, false); ?>. Please check and approve.',
      icon: 'success',
      buttons: true,
      dangerMode: false,
  })
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/resources/views/home/index.blade.php ENDPATH**/ ?>