...
<?php $__env->startSection('title', __('mpcs::lang.16A_form')); ?>
        ...
        <div class="col-md-12">
            <div class="settlement_tabs">
               <ul class="nav nav-tabs">
                    <!-- <?php if(auth()->user()->can('f16a_form')): ?>
                    <li class="active">
                        <a href="#16a_form_tab" class="16a_form_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.16A_form'); ?></strong>
                        </a>
                    </li>
                    <?php endif; ?> -->
                    <?php if(auth()->user()->can('f16a_form')): ?>
                    ...
                    <li class="">
                        <a href="#16a_form_list_tab" class="16a_form_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.16A_form_settings'); ?></strong>
                        </a>
                    </li>
                    <?php endif; ?>
               </ul>        
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="16A_form_tab">
                        <?php echo $__env->make('mpcs::forms.partials.16a_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endif; ?>
                    <?php if(auth()->user()->can('16a_form')): ?>
                    <div class="tab-pane" id="16a_form_list_tab">
                          <?php echo $__env->make('mpcs::forms.partials.list_f16', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/Modules/MPCS/Providers/../Resources/views/forms/F16A.blade.php ENDPATH**/ ?>