...
<section class="content">
	...
	<?php echo Form::open(['url' => action('\Modules\Manufacturing\Http\Controllers\ProductionController@store'), 'method' =>
	...
	<div class="row">
		...
		<div class="col-sm-3">
			<div class="form-group">
				...
				<div class="input-group">
					...
					<?php echo Form::text('transaction_date', \Carbon::createFromTimestamp(strtotime('now'))->format(session('business.date_format') . ' ' . 'H:i'), ['class' => 'form-control', 'readonly',
					'required']); ?>
		...
		<div class="col-sm-3">
			<div class="form-group">
                ...
                ?>
				<?php echo Form::select('location_id', $business_locations, $default_location, ['class' => 'form-control
		...
		<div class="col-sm-3">
			<div class="form-group">
				...
				<?php echo Form::select('variation_id', $recipe_dropdown, null, ['class' => 'form-control select2',
		...
		<div class="col-sm-3">
			<div class="form-group">
				...
				<div class="input-group" id="recipe_quantity_input">
					<?php echo Form::text('quantity', 1, ['class' => 'form-control input_number', 'id' => 'recipe_quantity',
	...
	<div class="row">
		...
		<div class="col-md-3">
			<div class="form-group">
				<?php echo Form::label('mfg_wasted_units', __('manufacturing::lang.waste_units').':'); ?>
		...
		<div class="col-md-3">
			<div class="form-group">
				<?php echo Form::label('production_cost', __('manufacturing::lang.production_cost').':'); ?>
			...
			<div class="form-group">
				...
				<div class="checkbox">
					<label>
						...
						<?php echo app('translator')->get('manufacturing::lang.finalize'); ?>
					</label> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
...
<?php /**PATH /home/vimi31/public_html/Modules/Manufacturing/Providers/../Resources/views/production/create.blade.php ENDPATH**/ ?>