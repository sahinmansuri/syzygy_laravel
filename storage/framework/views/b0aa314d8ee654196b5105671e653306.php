<?php echo Form::open(['url' => action('\Modules\Petro\Http\Controllers\PumpOperatorPaymentController@saveCardPayment'), 'method' =>'post']); ?>
        ...
        <div class="row">
            <div class="col-md-2">
                <div class="form-group">
                    <?php echo Form::label('card_pmt_type', __('petro::lang.type')).':'; ?>

                    <select id="card_pmt_type" class="form-control">
                        <option value="one_by_one" <?php if($card_pmt_type != 'bulk'): ?> selected <?php endif; ?>>
                            <?php echo e(__('petro::lang.one_by_one'), false); ?>

                        </option>
                        <option value="bulk" <?php if($card_pmt_type == 'bulk'): ?> selected <?php endif; ?>>
                            <?php echo e(__('petro::lang.bulk'), false); ?>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <?php echo Form::label('card_type', __('petro::lang.card_type').':'); ?>

                    <?php echo Form::select('card_type', $card_types, null, ['class' => 'form-control select2',
                    'style' => 'width: 100%;','placeholder' => __('messages.please_select')]); ?>

                </div>
            </div>
            
            <div class="col-md-2 card-fields" <?php if($card_pmt_type == 'bulk'): ?> hidden <?php endif; ?>>
                <div class="form-group">
                    <?php echo Form::label('slip_no', __('petro::lang.slip_no')); ?>

                    <?php echo Form::text('slip_no', null, [
            ...
            <div class="col-md-3 card-fields" <?php if($card_pmt_type == 'bulk'): ?> hidden <?php endif; ?>>
                <div class="form-group">
                    <?php echo Form::label('card_no', __('petro::lang.card_number')); ?>

                    <?php echo Form::text('card_no', null, [
                        'class' => 'form-control card_payment_input',
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <?php echo Form::label('card_amount', __( 'petro::lang.amount' ) ); ?>

                    <?php echo Form::text('card_amount', null, ['class' => 'form-control card_payment_input',
            ...
            <div class="col-md-2 pull-right">
                <button type="button" class="btn btn-primary pull-right card_payment_add"
                    style="margin: 10px;"><?php echo app('translator')->get('messages.add'); ?></button>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table table-bordered table-striped" id="card_payment_table">
                    <thead>
                        <tr>
                            <th><?php echo app('translator')->get('petro::lang.card_type' ); ?></th>
                            <th><?php echo app('translator')->get('petro::lang.slip_no' ); ?></th>
                            <th><?php echo app('translator')->get('petro::lang.card_number' ); ?></th>
            ...
            style="margin-top: 23px;"><?php echo app('translator')->get('petro::lang.save'); ?></button>
...
</script><?php /**PATH /home/vimi31/public_html/Modules/Petro/Providers/../Resources/views/pump_operators/card_payment.blade.php ENDPATH**/ ?>