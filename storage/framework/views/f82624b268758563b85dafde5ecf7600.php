<?php $__env->startSection('title', __('cheque.cheque_number')); ?>

<?php $__env->startSection('content'); ?>

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1><?php echo app('translator')->get('cheque.cheque_number'); ?></h1>
     <div class="box box-info">
        ...
        <div class="box-body">
            <?php echo e(Form::open(array('id' => 'filterForm')), false); ?>

            <div class="row">
                <div class="col-md-3">
                    <?php echo Form::label('bank_acount_no',__('lang_v1.bank_account_no') . ':'); ?>

                    <?php echo Form::select('bank_acount_no', $accounts, ($defaultVal)?$defaultVal['bank_acount_no']:null, ['placeholder' =>__('report.all'), 'class' => 'form-control select2 filter-control', 'style' => 'width:100%', 'id' =>'bank_acount_no']); ?>

                </div>
                <div class="col-md-3">
                    <?php echo Form::label('cheque_no',__('cheque.cheque_number') . ':'); ?>

                    <?php echo Form::select('cheque_no', $chequeNumbers, ($defaultVal)?$defaultVal['cheque_no']:null, ['placeholder' =>__('report.all'), 'class' => 'form-control select2 filter-control', 'style' => 'width:100%', 'id' =>'cheque_no']); ?>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <?php echo Form::text('date_range', ($defaultVal === 'all') ? 'Todos' : (($defaultVal) ? $defaultVal['startDate'] . ' - ' . $defaultVal['endDate'] : @date('m/01/Y') . ' - ' . @date('m/t/Y')), [
...
<section class="content">
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'title' => __( 'cheque.cheque_number_list')]); ?>

    <?php $__env->slot('tool'); ?>
    <div class="box-tools pull-right">
        <div class="box-tools">
            <button type="button" class="btn  btn-primary"   id="cheque_number_add" data-href="<?php echo e(action('Chequer\ChequeNumberController@create'), false); ?>" >
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped" id="cheque_number_table">
            <thead>
                <tr>
                    <th><?php echo app('translator')->get('cheque.data_tiime'); ?></th>
                    <th><?php echo app('translator')->get('account.bank_account'); ?></th>
                    <th><?php echo app('translator')->get('cheque.Cheque Book No'); ?></th>
                    <th><?php echo app('translator')->get('cheque.first_cheque_number'); ?></th>
                    <th><?php echo app('translator')->get('cheque.last_cheque_number'); ?></th>
                    <th><?php echo app('translator')->get('cheque.no_of_cheque_leaves'); ?></th>
                    <th><?php echo app('translator')->get('cheque.user'); ?></th>
                </tr>
            </thead>
...
$(document).ready(function() {
    ...
    var cheque_number_table = $('#cheque_number_table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo e(action("Chequer\ChequeNumberController@index"), false); ?>',
            data: function(d) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/resources/views/chequer/cheque_number/index.blade.php ENDPATH**/ ?>