    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left"><?php echo app('translator')->get('lang_v1.list_quotations'); ?></h4>
                <ul class="breadcrumbs pull-left" style="margin-top: 15px">
                    <li><a href="#">Sales</a></li>
                    <li><span>><?php echo app('translator')->get('lang_v1.list_quotations'); ?></span></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'date' => '-']); ?>
        <?php $__env->slot('tool'); ?>
            <div class="box-tools pull-right">
                <a class="btn btn-primary" href="<?php echo e(action('SellPosController@create', ['type' => 'quotation']), false); ?>">
            ...
            <table class="table table-bordered table-striped ajax_view" id="sell_table">
                <thead>
                    <tr>
                        ...
                        <th><?php echo app('translator')->get('lang_v1.quotation_no'); ?></th>
                        <th><?php echo app('translator')->get('lang_v1.sale_no'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/resources/views/sale_pos/quotations.blade.php ENDPATH**/ ?>