...
.custom-alert button {
    ...
    </style><?php if(session('success') || session('error')): ?>
    <div id="custom-alert" class="custom-alert <?php echo e(session('success') ? 'success' : 'error', false); ?>">
        <span><?php echo e(session('success') ?? session('error'), false); ?></span>
                        ...
                        <div class="container">
                            <div class="row" style="margin-top: 5px;">
                                <div class="col-sm-10 text-center">
                                    ...
                                    <h1><?php echo e($business_name, false); ?></h1>
...
<h5 style="font-size: 15px;text-align: right;font-weight: bolder;margin-top: 8px;">Form No. &nbsp; <?php echo e($next_form_number, false); ?></h5>
...
<?php /**PATH /home/vimi31/public_html/Modules/MPCS/Providers/../Resources/views/forms/partials/15_forms.blade.php ENDPATH**/ ?>