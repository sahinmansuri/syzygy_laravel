<?php $__env->startSection('title', __('mpcs::lang.15_form')); ?>
               ...
               <ul class="nav nav-tabs">
                    ...
                    <li class="active">
                        <a href="#15_form_tab" class="15_form_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.15_form'); ?></strong>
                        </a>
                    </li>
                    <?php endif; ?> -->
                    <?php if(auth()->user()->can('f15_form')): ?>
                    ...
                    <li class="">
                        <a href="#15_form_list_tab" class="15_form_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.15_form_settings'); ?></strong>
                        </a>
                    </li>
                    <?php endif; ?>
               </ul>        
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="15_form_tab">
                        <?php echo $__env->make('mpcs::forms.partials.15_forms', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endif; ?>
                    <?php if(auth()->user()->can('15_form')): ?>
                    <div class="tab-pane" id="15_form_list_tab">
                          <?php echo $__env->make('mpcs::forms.partials.list_f15', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/Modules/MPCS/Providers/../Resources/views/forms/F15.blade.php ENDPATH**/ ?>