...
<div class="pos-tab-content">
    <div class="row">
        <div class="col-xs-3">
            <div class="form-group">
                <?php echo Form::label('default_gateway', __('lang_v1.default_gateway') . ':'); ?>

                <?php echo Form::select('sms_settings[default_gateway]', ['direct' => 'Direct', 'utlimate_sms' => 'Ultimate SMS', 'hutch_sms' => 'Hutch SMS'], !empty($sms_settings['default_gateway']) ? $sms_settings['default_gateway'] : null, ['class' => 'form-control', 'id' => 'default_gateway']); ?>
        ...
        <div class="col-xs-12">
            <div class="form-group">
                <?php echo Form::label('msg_phone_nos', __('lang_v1.msg_phone_nos') . ':'); ?> <small>(<?php echo app('translator')->get('lang_v1.separate_comma'); ?> )</small><br>
                <?php echo Form::text('sms_settings[msg_phone_nos]', !empty($sms_settings['msg_phone_nos']) ? $sms_settings['msg_phone_nos']: null, ['style' => 'width: 100% !important;','class' => 'form-control', 'id' => 'msg_phone_nos','data-role' => "tagsinput"]); ?>
    ...
    <div class="row ultimate_sms <?php if(!empty($sms_settings['default_gateway']) && $sms_settings['default_gateway'] != 'utlimate'): ?> hide <?php endif; ?> ">
        <div class="col-xs-12"> <strong><h5><?php echo e(__('lang_v1.ultimate_sms_details'), false); ?></h5></strong></div>
        <div class="col-xs-6">
            <div class="form-group">
                <?php echo Form::label('ultimate_token', __('lang_v1.ultimate_token') . ':'); ?>

                <?php echo Form::text('sms_settings[ultimate_token]', !empty($sms_settings['ultimate_token']) ? $sms_settings['ultimate_token'] : null, ['class' => 'form-control', 'id' => 'ultimate_token']); ?>

            </div>
        </div>
        <div class="col-xs-3">
            <div class="form-group">
                <?php echo Form::label('ultimate_sender_id', __('lang_v1.ultimate_sender_id') . ':'); ?>

                <?php echo Form::text('sms_settings[ultimate_sender_id]', !empty($sms_settings['ultimate_sender_id']) ? $sms_settings['ultimate_sender_id'] : null, ['class' => 'form-control', 'id' => 'ultimate_sender_id']); ?>
    ...
    <div class="row hutch_sms <?php if(!empty($sms_settings['default_gateway']) && $sms_settings['default_gateway'] != 'hutch_sms'): ?> hide <?php endif; ?>">
        <div class="col-xs-12"> <strong><h5><?php echo e(__('lang_v1.hutch_sms_details'), false); ?></h5></strong></div>
        <div class="col-xs-4">
            <div class="form-group">
                <?php echo Form::label('hutch_username', __('lang_v1.hutch_username') . ':'); ?>

                <?php echo Form::text('sms_settings[hutch_username]', !empty($sms_settings['hutch_username']) ? $sms_settings['hutch_username'] : null, ['class' => 'form-control', 'id' => 'hutch_username']); ?>

            </div>
        </div>
        <div class="col-xs-4">
            <div class="form-group">
                <?php echo Form::label('hutch_password', __('lang_v1.hutch_password') . ':'); ?>

                <?php echo Form::text('sms_settings[hutch_password]', !empty($sms_settings['hutch_password']) ? $sms_settings['hutch_password'] : null, ['class' => 'form-control', 'id' => 'hutch_password']); ?>
        ...
        <div class="col-xs-4">
            <div class="form-group">
                <?php echo Form::label('hutch_mask', __('lang_v1.hutch_mask') . ':'); ?>

                <?php echo Form::text('sms_settings[hutch_mask]', !empty($sms_settings['hutch_mask']) ? $sms_settings['hutch_mask'] : null, ['class' => 'form-control', 'id' => 'hutch_mask']); ?>
    ...
    <div class="row direct  <?php if(!empty($sms_settings['default_gateway']) && $sms_settings['default_gateway'] != 'direct'): ?> hide <?php endif; ?>">
        <div class="col-xs-3">
            <div class="form-group">
        ...
        <table class="table table-bordered table-striped" style="width: 100%" id="numbers_table">
            <thead>
                <tr>
                    ...
                    <th><?php echo app('translator')->get('lang_v1.general_notifications'); ?></th>
                    <th><?php echo app('translator')->get('lang_v1.customer_notifications'); ?></th>
                    <th><?php echo app('translator')->get('lang_v1.supplier_notifications'); ?></th>
                    <th>*</th>
                </tr>
            </thead>
            
            <tbody>
                <?php if(empty($notification_numbers)): ?>
                <tr>
                    <td>
                    ...
                    <td class="text-left">
                        <?php $__currentLoopData = $general_notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo e($notification['name'], false); ?> <?php echo Form::checkbox($key . '[]', 1, false, ['class' => 'toggler', 'data-toggle_id' => 'base_unit_div']); ?><br>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </td>
                    
                    <td class="text-left">
                        <?php $__currentLoopData = $customer_notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo e($notification['name'], false); ?> <?php echo Form::checkbox($key . '[]', 1, false, ['class' => 'toggler', 'data-toggle_id' => 'base_unit_div']); ?><br>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </td>
                    
                    <td class="text-left">
                        <?php $__currentLoopData = $supplier_notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo e($notification['name'], false); ?> <?php echo Form::checkbox($key . '[]', 1, false, ['class' => 'toggler', 'data-toggle_id' => 'base_unit_div']); ?><br>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </td>
                ...
                <?php else: ?>
                    ...
                    <?php $__currentLoopData = $notification_numbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $no): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                            <?php echo Form::text('phone_name[]', !empty($no['phone_name']) ? $no['phone_name'] : null, ['class' => 'form-control notification_fields']); ?>

                            </td>
                            
                            <td>
                                <?php echo Form::text('phone_number[]', $no['phone_number'], ['class' => 'form-control', 'required']); ?>

                            </td>
                            
                            <td class="text-left">
                                <?php $__currentLoopData = $general_notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo e($notification['name'], false); ?> <?php echo Form::checkbox($key . '[]', 1, !empty($no['notifications'][$key]) ? $no['notifications'][$key] : false, ['class' => 'toggler', 'data-toggle_id' => 'base_unit_div']); ?><br>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </td>
        ...
        <input type="hidden" id="notification_parameters" value="<?php echo e(!empty($sms_settings['notification_parameters']) ? $sms_settings['notification_parameters'] : null, false); ?>" name="sms_settings[notification_parameters]">
        ...
        <div class="col-xs-4">
            <div class="form-group">
                <?php echo Form::label('sms_settings_header_1', __('lang_v1.sms_settings_header_val', ['number' => 1]) . ':'); ?>

                <?php echo Form::text('sms_settings[header_1]', !empty($sms_settings['header_1']) ? $sms_settings['header_1'] : null, ['class' => 'form-control', 'placeholder' => __('lang_v1.sms_settings_header_val', ['number' => 1]), 'id' => 'sms_settings_header_1' ]); ?>

            </div>
        </div>
        <div class="col-xs-4">
            <div class="form-group">
                <?php echo Form::label('sms_settings_header_2', __('lang_v1.sms_settings_header_val', ['number' => 2]) . ':'); ?>

                <?php echo Form::text('sms_settings[header_1]', !empty($sms_settings['header_2']) ? $sms_settings['header_2'] : null, ['class' => 'form-control', 'placeholder' => __('lang_v1.sms_settings_header_val', ['number' => 2]), 'id' => 'sms_settings_header_2' ]); ?>

            </div>
        </div>
        <div class="col-xs-4">
            <div class="form-group">
                <?php echo Form::label('sms_settings_header_3', __('lang_v1.sms_settings_header_val', ['number' => 3]) . ':'); ?>

                <?php echo Form::text('sms_settings[header_3]', !empty($sms_settings['header_3']) ? $sms_settings['header_3'] : null, ['class' => 'form-control', 'placeholder' => __('lang_v1.sms_settings_header_val', ['number' => 3]), 'id' => 'sms_settings_header_3' ]); ?>
...
</script><?php /**PATH /home/vimi31/public_html/resources/views/business/partials/settings_sms.blade.php ENDPATH**/ ?>