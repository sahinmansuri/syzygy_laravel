						...
						<div class="row">
							<div id="payment_rows_div">
								...
								<?php $__currentLoopData = $payment_lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment_line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									<?php echo $__env->make('sale_pos.partials.payment_row', ['removable' => !$loop->first, 'row_index' => $loop->index, 'payment_line' => $payment_line, 'payment' => !empty($temp_data->payment)?$temp_data->payment[$loop->index]:[]], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</div><?php /**PATH /home/vimi31/public_html/resources/views/purchase/partials/payment_modal.blade.php ENDPATH**/ ?>