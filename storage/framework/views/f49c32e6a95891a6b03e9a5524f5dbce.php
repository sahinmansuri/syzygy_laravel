            ...
            <div class="box-tools">
                ...
                <button class="btn btn-primary print_report pull-right" id="print_div">
                    ...
                    <div class="col-md-12" style="margin-top: 20px;">
                        ...
                        <h3><?php echo app('translator')->get('mpcs::lang.cash_sales_details'); ?></h3>
                    </div>
                    <table width="100%" style="margin-top: 0px;" class="no-border-table">
                                <tr style="border: none;">
...
<!-- /.content --><?php /**PATH /home/vimi31/public_html/Modules/MPCS/Providers/../Resources/views/forms/partials/9c_form.blade.php ENDPATH**/ ?>