...
<link rel="stylesheet"
    href="<?php echo e(asset('plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.min.css?v='.$asset_v), false); ?>">
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left"><?php echo app('translator')->get('account.manage_your_account'); ?></h4>
                <ul class="breadcrumbs pull-left" style="margin-top: 15px">
                    <li><a href="#"><?php echo app('translator')->get('lang_v1.payment_accounts'); ?></a></li>
                    <li><span><?php echo app('translator')->get('account.manage_your_account'); ?></span></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <ul class="nav nav-tabs">
                    <li class="<?php if(empty(session('status.tab'))): ?> active <?php endif; ?>">
                        <a href="#other_accounts" data-toggle="tab">
                            <i class="fa fa-book"></i> <strong><?php echo app('translator')->get('account.list_accounts'); ?></strong>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#account_groups" data-toggle="tab">
                            <i class="fa fa-object-group"></i> <strong>
                                <?php echo app('translator')->get('lang_v1.account_groups'); ?> </strong>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#account_settings" data-toggle="tab">
                            <i class="fa fa-cogs"></i> <strong>
                                <?php echo app('translator')->get('lang_v1.account_settings'); ?> </strong>
                        </a>
                    </li>
                    <?php endif; ?>
                    <li class="<?php if(session('status.tab') == 'list_deposit_transfer'): ?> active <?php endif; ?>">
                        <a href="#list_deposit_transfer" data-toggle="tab">
                            <i class="fa fa-list"></i> <strong>
                                <?php echo app('translator')->get('lang_v1.list_deposit_transfer'); ?> </strong>
                        </a>
                    </li>
                    
                    <li class="<?php if(session('status.tab') == 'cheques_ob_details'): ?> active <?php endif; ?>">
                        <a href="#cheques_ob_details" data-toggle="tab">
                            <i class="fa fa-list"></i> <strong>
                                <?php echo app('translator')->get('lang_v1.cheques_ob_details'); ?> </strong>
                        </a>
                    </li>
                    
                </ul>
                <div class="tab-content">
                    <div class="tab-pane <?php if(empty(session('status.tab'))): ?> active <?php endif; ?>" id="other_accounts">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <button style="margin-right: 25px;"
                                        data-href="<?php echo e(action('AccountController@getDeposit', ['card']), false); ?>"
                                        class="btn btn-sm btn-warning btn-modal  pull-right deposit_btn"
                                        data-container=".account_model"><i class="fa fa-money"></i>
                                        <?php echo app('translator')->get("account.card_deposit"); ?></button>

                                    <button style="margin-right: 25px;"
                                        data-href="<?php echo e(action('AccountController@getChequeDeposit'), false); ?>"
                                        class="btn btn-sm btn-info btn-modal  pull-right deposit_btn"
                                        data-container=".account_model"><i class="fa fa-address-card-o"></i>
                                        <?php echo app('translator')->get("account.cheque_deposit"); ?></button>
                                    
                                   <?php if(!empty($pacakge_details['realize_cheque'])): ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('deposits.realize_cheque')): ?>    
                                            <button style="margin-right: 25px;"
                                                data-href="<?php echo e(action('AccountController@getRealizeChequeDeposit'), false); ?>"
                                                class="btn btn-sm btn-danger btn-modal  pull-right deposit_btn"
                                                data-container=".account_model"><i class="fa fa-address-card-o"></i>
                                                <?php echo app('translator')->get("account.realize_cheque"); ?></button>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                        
                                        
                                    <button style="margin-right: 25px;"
                                        data-href="<?php echo e(action('AccountController@getDeposit', ['cash']), false); ?>"
                                        class="btn btn-sm btn-success btn-modal  pull-right deposit_btn"
                                        data-container=".account_model"><i class="fa fa-money"></i>
                                        <?php echo app('translator')->get("account.cash_deposit"); ?></button>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="row">
                            <?php $__env->startComponent('components.filters', ['title' => __('report.filters')]); ?>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <?php echo Form::label('account_type',  __('Account Type') . ':'); ?>

                                        <?php echo Form::select('account_type', $account_types_opts, null, ['id'=>'account_type','class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); ?>

                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <?php echo Form::label('account_sub_type',  __('Account Sub Type') . ':'); ?>

                                        <?php echo Form::select('account_sub_type', $sub_acn_arr, null, ['id'=>'account_sub_type','class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); ?>

                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <?php echo Form::label('account_group',  __('Account Group') . ':'); ?>

                                        <?php echo Form::select('account_group', $account_groups, null, ['id'=>'account_group','class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); ?>

                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <?php echo Form::label('account_name',  __('Account Name') . ':'); ?>

                                        <?php echo Form::select('account_name', $accounts, null, ['id'=>'account_name','class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <?php echo Form::label('location_id',  __('lang_v1.location') . ':'); ?>

                                        <?php echo Form::select('location_id', $_business_locations, null, ['id'=>'list_accounts_location_id','class' => 'form-control select2', 'style' => 'width:100%']); ?>
                                ...
                                <table class="table table-bordered table-striped" id="other_account_table"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo app('translator')->get( 'lang_v1.account_type' ); ?> / <?php echo app('translator')->get( 'lang_v1.account_sub_type' ); ?></th>
                                            <th><?php echo app('translator')->get( 'account.account_group' ); ?></th>
                                            <th><?php echo app('translator')->get( 'account.parent_account' ); ?></th>
                    ...
                    <div class="tab-pane" id="account_types">
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-primary btn-modal pull-right" <?php if(!$account_access): ?>
                                    disabled <?php endif; ?> data-href="<?php echo e(action('AccountTypeController@create'), false); ?>"
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="account_type_<?php echo e($account_type->id, false); ?>">
                                            ...
                                            <td>
                                                ...
                                                <?php echo Form::open(['url' => action('AccountTypeController@destroy',
                    ...
                    <div class="tab-pane" id="account_groups">
                        <div class="row">
                            <!--<div class="col-md-12">-->
                            <!--    <button type="button" class="btn btn-primary btn-modal pull-right" <?php if(!$account_access): ?>-->
                            <!--        disabled <?php endif; ?> id="add_acount_group_btn"-->
                            <!--        data-href="<?php echo e(action('AccountGroupController@create'), false); ?>"-->
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped table-bordered" id="account_groups_table"
                                    ...
                                    <thead>
                                        <tr>
                                            <th><?php echo app('translator')->get( 'lang_v1.name' ); ?></th>
                                            <th><?php echo app('translator')->get( 'lang_v1.account_type_name' ); ?></th>
                    ...
                    <div class="tab-pane" id="account_settings">
                        <?php echo $__env->make('account_settings.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endif; ?>
                    <div class="tab-pane <?php if(session('status.tab') == 'list_deposit_transfer'): ?> active <?php endif; ?>" id="list_deposit_transfer">
                        <?php echo $__env->make('account.list_deposit_transfer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    
                    <div class="tab-pane <?php if(session('status.tab') == 'cheques_ob_details'): ?> active <?php endif; ?>" id="cheques_ob_details">
                        <?php echo $__env->make('account.cheques_opening_balance_details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
<script>
      ...
      var item_element = `
        <div class="form-group col-sm-4 added-amount">
            <div class="input-group">
              <?php echo Form::number('amount[]', null, ['class' => 'form-control input_amount', 'required','placeholder' => __(
    ...
    $(document).ready(function(){
        ...
        function loadNamesOtion(){
            ...
            // postData +=    "&_token = <?php echo e(csrf_token(), false); ?>";
            $.ajax({
                method: "post",
    ...
    function get_cheques_list(){
        if($('#transaction_date_range_cheque_deposit').val()){
            ...
            $.ajax({
                method: 'get',
                url: '<?php echo e(action("AccountController@getChequeList"), false); ?>',
    ...
    function get_realize_cheques_list(){
        ...
        if($('#realize_cheque_date').val()){
            ...
            $.ajax({
                method: 'get',
                url: '<?php echo e(action("AccountController@getRealizeChequeList"), false); ?>',
    ...
    $(document).ready(function () {
        account_setting_table = $('#account_setting_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url: "<?php echo e(action('AccountSettingController@index'), false); ?>",
                data: function(d){
                    d.date = $('#date1').val();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/resources/views/account/index.blade.php ENDPATH**/ ?>