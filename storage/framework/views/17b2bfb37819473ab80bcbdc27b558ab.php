<?php $__env->startSection('title', __('sms::lang.sms')); ?>
...
<section class="content">
        ...
        <div class="col-md-12 dip_tab">
            <div class="settlement_tabs">
                <ul class="nav nav-tabs">
                    <?php if(!empty($pacakge_details['list_sms']) && auth()->user()->can('sms_list_sms')): ?>
                    <li class="active" style="margin-left: 20px;">
                        <a style="font-size:13px;" href="#sms" class="" data-toggle="tab">
                            <i class="fa fa-superpowers"></i> <strong><?php echo app('translator')->get('sms::lang.sms'); ?></strong>
                        </a>
                    </li>
                    <?php endif; ?>
                    
                    <?php if(!empty($pacakge_details['sms_history']) && auth()->user()->can('sms_history')): ?>
                    <li class="">
                        <a style="font-size:13px;" href="#sms_history" data-toggle="tab">
                            <i class="fa fa-thermometer"></i> <strong><?php echo app('translator')->get('sms::lang.sms_history'); ?></strong>
                        </a>
                    </li>
                    <?php endif; ?>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="sms">
            <?php echo $__env->make('sms::list_sms.list_sms', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <?php endif; ?>
        
        <?php if(!empty($pacakge_details['sms_history']) && auth()->user()->can('sms_history')): ?>
        <div class="tab-pane" id="sms_history">
            <?php echo $__env->make('sms::list_sms.sms_history', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <?php endif; ?>
    </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h4 class="modal-title"><?php echo app('translator')->get( 'superadmin::lang.message' ); ?></h4>
...
<script>
    ...
    $(document).ready(function(){
        ...
        sms_history_table = $('#sms_history_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(url('sms/sms-logs'), false); ?>",
                data: function(d) {
        ...
        sms_table = $('#sms_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url : "<?php echo e(action('\Modules\SMS\Http\Controllers\SMSController@index'), false); ?>",
                data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/Modules/SMS/Providers/../Resources/views/list_sms/index.blade.php ENDPATH**/ ?>