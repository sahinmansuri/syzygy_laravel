...
<?php echo Form::open(['url' => action('AccountSettingController@store'), 'method' => 'post', 'id' =>
...
<div class="row">
    <div class="col-md-12">
        <h3><?php echo app('translator')->get('lang_v1.account_opening_balances'); ?></h3>
    </div>
</div>
<br>
<div class="row">
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-3">
             ...
             <div class="col-md-3">
                <div class="form-group">
                    ...
                    <?php echo Form::select('account_type', $account_types_opts, null, ['id'=>'account_type','class' => 'form-control select2', 'required', 'style' => 'width:100%', 'placeholder' => __('messages.please_select')]); ?>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <?php echo Form::select('account_sub_type', $sub_acn_arr, null, ['id'=>'account_sub_type','class' => 'form-control select2','required',  'style' => 'width:100%', 'placeholder' => __('messages.please_select')]); ?>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <?php echo Form::label('group_id', __( 'lang_v1.account_group' ) . ':'); ?>

                    <?php echo Form::select('group_id', $account_groups, null, ['placeholder' =>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    <?php echo Form::label('account_id', __( 'lang_v1.account' ) . ':'); ?>

                    <?php echo Form::select('account_id', [], null, ['placeholder' =>
            ...
            <div class="col-md-3 chequeRelated" hidden>
                <div class="form-group">
                    ...
                    <?php echo Form::select('customer_id', $customers, null, ['placeholder' =>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <?php echo Form::text('amount', null, ['required','class' => 'form-control',
                    'placeholder' => __(
                    'lang_v1.amount' ) ]); ?>
    ...
    <div class="col-md-12">
        <button type="submit" id="saveForm" class="btn btn-primary pull-right"><?php echo app('translator')->get('lang_v1.save'); ?></button>
    </div>
</div>
...
<br>
 <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                <?php echo Form::label('date1', __( 'lang_v1.date' ) . ':'); ?>

                <?php echo Form::text('date1', null, ['class' => 'form-control', 'placeholder' => __('lang_v1.date' ) ,'readonly']); ?>

                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <?php echo Form::label('account_type1',  __('Account Type') . ':'); ?>

                    <?php echo Form::select('account_type1', $account_types_opts, null, ['id'=>'account_type1','class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); ?>

                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <?php echo Form::label('account_sub_type1',  __('Account Sub Type') . ':'); ?>

                    <?php echo Form::select('account_sub_type1', $sub_acn_arr, null, ['id'=>'account_sub_type1','class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); ?>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                <?php echo Form::label('group_id2', __( 'lang_v1.account_group' ) . ':'); ?>

                <?php echo Form::select('group_id2', $account_groups, null, ['placeholder' =>__('messages.please_select'), 'required','style' => 'width: 100%', 'class' => 'form-control select2']); ?>

                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                <?php echo Form::label('account_id2', __( 'lang_v1.account' ) . ':'); ?>

                <?php echo Form::select('account_id2', [], null, ['placeholder' =>__('messages.please_select'), 'required','style' => 'width: 100%', 'class' => 'form-control select2']); ?>
            ...
            <table class="table table-bordered table-striped" id="account_setting_table" style="width: 100%;">
                <thead>
                    <tr>
                        ...
                        <th><?php echo app('translator')->get( 'lang_v1.account_group' ); ?></th>
                        <th><?php echo app('translator')->get( 'lang_v1.account' ); ?></th>
      ...
      <div class="modal-body">
          ...
          <form id="chequeDetailsForm">
               <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <?php echo Form::label('cheque_amount', 'Amount:'); ?>

                        <?php echo Form::text('cheque_amount[]', null, ['class' => 'form-control cheque_amount',
                        'placeholder' => 'Amount' ]); ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <?php echo Form::label('cheque_date','Cheque Date:'); ?>

                        <?php echo Form::date('cheque_date[]', null, ['class' => 'cheque_date form-control',
                        'placeholder' => __(
                        'lang_v1.date' ) ]); ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <?php echo Form::label('cheque_bank', 'Bank:'); ?>

                        <?php echo Form::text('bank_name[]', null, ['class' => 'cheque_bank form-control',
                        'placeholder' => 'Bank' ]); ?>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <?php echo Form::label('cheque_number', 'Cheque Number:'); ?>

                        <?php echo Form::text('cheque_number[]', null, ['class' => 'cheque_number form-control',
...
<script>
    $('.cheque_acc_id').change(function() {
        if($(this).val() == "<?php echo e($chequeId, false); ?>"){
    ...
    $("#amount").blur(function() {
        if($('.cheque_acc_id').val() == "<?php echo e($chequeId, false); ?>"){
            calculateTotals();
            popupModal();
        }
    });
...
</script><?php /**PATH /home/vimi31/public_html/resources/views/account_settings/index.blade.php ENDPATH**/ ?>