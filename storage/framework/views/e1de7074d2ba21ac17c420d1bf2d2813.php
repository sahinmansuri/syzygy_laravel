<?php $__env->startSection('title', __('mpcs::lang.9c_cash_form')); ?>
            ...
            <div class="settlement_tabs">
                <ul class="nav nav-tabs">
                    ...
                    <li class="">
                        <a href="#9a_form_settings_tab" class="9a_form_settings_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.form_9_c_settings'); ?></strong>
                        </a>
                    </li>
                    <?php endif; ?>
                </ul>
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="9a_form_settings_tab">
                        <?php echo $__env->make('mpcs::forms.partials.9c_settings_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/Modules/MPCS/Providers/../Resources/views/forms/form_9c.blade.php ENDPATH**/ ?>