<?php $__env->startSection('title', __('petro::lang.meters_with_payments')); ?>

<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <div class="col-md-12">
            <h1 class="pull-left"><?php echo app('translator')->get('petro::lang.meters_with_payments'); ?></h1>
            <h2 style="color: red; text-align: center;">Shift_NO: <?php echo e($shift_number, false); ?></h2>
        </div>
        <a href="<?php echo e(action('Auth\PumpOperatorLoginController@logout'), false); ?>" class="btn btn-flat btn-lg pull-right" style=" background-color: orange; color: #fff; margin-left: 5px;">
            <?php echo app('translator')->get('petro::lang.logout'); ?>
        </a>
        <a href="<?php echo e(action('\Modules\Petro\Http\Controllers\PumpOperatorController@dashboard'), false); ?>" class="btn btn-flat btn-lg pull-right" style="color: #fff; background-color:#810040;">
            <?php echo app('translator')->get('petro::lang.dashboard'); ?>
        </a>
    </section>

    <div class="clearfix"></div>

    <?php echo $__env->make('petro::pump_operators.partials.meters_with_payments', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready( function(){
            ...
            pump_operators_meters_with_payments_table = $('#pump_operators_meters_with_payments_table').DataTable({
                ...
                aaSorting: [[0, 'asc']],
                ajax: {
                    url: "<?php echo e(action('\Modules\Petro\Http\Controllers\PumpOperatorPaymentController@metersWithPayments', ['only_pumper' => true]), false); ?>",
                    data: function(d) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.'.$layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/Modules/Petro/Providers/../Resources/views/pump_operators/meters_with_payments.blade.php ENDPATH**/ ?>