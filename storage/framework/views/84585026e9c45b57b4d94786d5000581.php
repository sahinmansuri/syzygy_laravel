        ...
        <div class="card-body">
            <table width="50%">
                <tbody>
                    ...
                    <td width="18%" style="text-align: left;"><h4><strong><?php echo e(date('Y-m-d H:i:s'), false); ?></strong></h4></td>
                    <td width="4%"></td>
                    <td width="23%"><h4>Ref Previous Form Number:</h4></td>
                    <td width="8%"><h4><strong><?php echo e($headers->id ?? 'N/A', false); ?></strong></h4></td>
                    <td width="8%"></td>
                    <td width="15%"><h4>User Added:</h4></td>
                    <td width="20%"><h4><strong><?php echo e(auth()->user()->name, false); ?> <?php echo e(auth()->user()->username, false); ?></strong></h4></td>
                </tr>
            </tbody></table>
        </div>
    </div>
<!-- end date and time Ref form -->
    <div class="row">
        <div class="box-tools pull-right" style="margin: 14px 20px 14px 0;">
            ...
            ?>
            <button type="button" class="btn btn-primary btn-modal  <?php if(auth()->user()->can('superadmin') || auth()->user()->id === $header): ?> left <?php endif; ?>"
                data-href="<?php echo e(action('\Modules\MPCS\Http\Controllers\F15FormController@get15FormSetting'), false); ?>"
                data-container="">
                <i class="fa fa-plus"></i> <?php echo app('translator')->get('mpcs::lang.add_15_form_settings'); ?></button>
        </div>
    </div>
    ...
    $(document).ready(function() {
        ...
        const startingNumberLabel =
            <?php if(auth()->user()->can('superadmin')): ?>
                'Form Number : - ';
            <?php else: ?>
                'Form Number : ' + '<?php echo e($headers->id, false); ?>';
            <?php endif; ?>
        ...
        var form_15_settings_table = $('#form_15_settings_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(action('\Modules\MPCS\Http\Controllers\F15FormController@mpcs15FormSettings'), false); ?>",
                type: 'GET',
...
<?php /**PATH /home/vimi31/public_html/Modules/MPCS/Providers/../Resources/views/forms/partials/list_f15.blade.php ENDPATH**/ ?>