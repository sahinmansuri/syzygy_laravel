<?php $__env->startSection('title', __('mpcs::lang.form_9_a')); ?>
            ...
            <div class="settlement_tabs">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active">
                        <a href="#9a_form_tab" class="9a_form_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.form_9_a'); ?></strong>
                        </a>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="">
                        <a href="#9a_form_settings_tab" class="9a_form_settings_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.form_9_a_settings'); ?></strong>
                        </a>
                    </li>
                    <?php endif; ?>
                </ul>
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="9a_form_tab">
                        <?php echo $__env->make('mpcs::forms.partials.9a_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endif; ?>
                    <?php if(auth()->user()->can('f9a_settings_form')): ?>
                    <div class="tab-pane" id="9a_form_settings_tab">
                        <?php echo $__env->make('mpcs::forms.partials.9a_settings_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function printDiv() {
            ...
            w.print();
            w.close();
            window.location.href = "<?php echo e(URL::to('/'), false); ?>/mpcs/form-9a";
        }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/Modules/MPCS/Providers/../Resources/views/forms/form_9a.blade.php ENDPATH**/ ?>