<?php $__env->startSection('title', __('essentials::lang.hrm_advance')); ?>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item active">
                        <a href="#salary_payment" class="salary_payment" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('essentials::lang.hrm_tab_salary_payment'); ?></strong>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#employee_advance" class="employee_advance" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('essentials::lang.hrm_tab_employee_advance'); ?></strong>
                        </a>
                    </li>
													...
													<div class="row">
														<div class="col-md-2">
															<div class="form-group">
																<label for="date"><?php echo app('translator')->get( 'essentials::lang.hrm_advance_label_date' ); ?></label>
																<input v-model="payment.date" class="form-control" ref="date" name="date" type="text">
															</div>
														</div>
														<div class="col-md-3">
															<div class="form-group">
																<label for="period"><?php echo app('translator')->get( 'essentials::lang.hrm_advance_label_period' ); ?></label>
																<input v-model="payment.period" class="form-control" ref="daterange" name="period" type="text" />
															</div>
														</div>
														<div class="col-md-3">
															<div class="form-group">
																<label for="period"><?php echo app('translator')->get( 'essentials::lang.hrm_advance_label_account' ); ?></label>
																<br />
														...
														<div class="col-md-2">
															<div class="form-group">
																<label for="paid"><?php echo app('translator')->get( 'essentials::lang.hrm_advance_label_paid' ); ?></label>
																<br />
																<select v-model="payment.paid" class="form-select filter-select" aria-label="Default select example" >
																	<option value=""></option>
																	<option value="yes">
																		<?php echo app('translator')->get( 'essentials::lang.hrm_advance_label_paid_yes' ); ?>
																	</option>
																	<option value="no">
																		<?php echo app('translator')->get( 'essentials::lang.hrm_advance_label_paid_no' ); ?>
																	</option>
																</select>
															</div>
														</div>
														<div class="col-md-2" v-if="showCheck">
															<div class="form-group">
																<label for="check"><?php echo app('translator')->get( 'essentials::lang.hrm_advance_label_check' ); ?>:</label>
						...
						<?php $__env->startComponent('components.widget', ['class' => 'box-solid']); ?>
							...
							<div class="table-responsive">
								...
								<table class="table table-bordered table-striped w-100" id="employees_table">
									<thead>
										<tr>
											<th width="10%"><?php echo app('translator')->get( 'essentials::lang.employee_no' ); ?></th>
											<th width="20%"><?php echo app('translator')->get( 'essentials::lang.employee_name' ); ?></th>
											<th width="35%"><?php echo app('translator')->get( 'essentials::lang.hrm_advance_title_amount' ); ?></th>
											<th width="35%" v-show="showPaidAmount"><?php echo app('translator')->get( 'essentials::lang.hrm_advance_title_paid' ); ?></th>
										</tr>
									</thead>
									<tbody>
								...
								<table class="table table-bordered table-striped w-100" id="advances_table">
									<thead>
										<tr>
											...
											<th width="2%">#</th>
											<th width="3%"><?php echo app('translator')->get( 'essentials::lang.employee_no' ); ?></th>
											<th width="20%"><?php echo app('translator')->get( 'essentials::lang.employee_name' ); ?></th>
											<th width="15%"><?php echo app('translator')->get( 'essentials::lang.hrm_advance_title_amount' ); ?></th>
											<th width="15%" ><?php echo app('translator')->get( 'essentials::lang.hrm_advance_title_paid' ); ?></th>
											<th width="15%" ><?php echo app('translator')->get( 'essentials::lang.hrm_advance_title_date' ); ?></th>
											<th width="15%" ><?php echo app('translator')->get( 'essentials::lang.hrm_advance_title_period_start' ); ?></th>
											<th width="15%" ><?php echo app('translator')->get( 'essentials::lang.hrm_advance_title_period_end' ); ?></th>
										</tr>
									</thead>
									<tbody>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<hr />
						<div class="form-group">
							<label for="paid"><?php echo app('translator')->get( 'essentials::lang.hrm_advance_title_amount' ); ?></label>
						...
						<div class="form-group">
							...
							<select v-model="advance.paid" class="form-select filter-select">
								<option value=""></option>
								<option value="yes"><?php echo app('translator')->get( 'essentials::lang.hrm_advance_label_paid_yes' ); ?></option>
								<option value="no"><?php echo app('translator')->get( 'essentials::lang.hrm_advance_label_paid_no' ); ?></option>
							</select>
						</div>
						<div class="form-group">
							<label for="paid"><?php echo app('translator')->get( 'essentials::lang.hrm_advance_title_paid' ); ?></label>
							<input v-model="advance.amount_paid" class="form-control" />
						</div>
						<div class="form-group">
							<label for="paid"><?php echo app('translator')->get( 'essentials::lang.hrm_advance_label_remarks' ); ?></label>
...
<script>
    new Vue({
        ...
        data() {
            return {
				advance: {},
                advances: <?php echo json_encode($advances); ?>,
                employees: <?php echo json_encode($employees); ?>,
                business: <?php echo json_encode($business); ?>,
                payment: {period:'<?php echo e($startdate, false); ?> to <?php echo e($enddate, false); ?>',date:'<?php echo e($today, false); ?>',paid:"no",check:'',account:''},
				accounts: <?php echo json_encode($accounts); ?>,
				accounts_with_check: <?php echo json_encode($accounts_with_check); ?>,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/Modules/Essentials/Providers/../Resources/views/advances/index.blade.php ENDPATH**/ ?>