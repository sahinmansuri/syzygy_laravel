<?php $__env->startSection('title', __('purchase.add_purchase_bulk')); ?>
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left"><?php echo app('translator')->get('purchase.add_purchase_bulk'); ?> <i class="fa fa-keyboard-o hover-q text-muted" aria-hidden="true"
			data-container="body" data-toggle="popover" data-placement="bottom"
			data-content="<?php echo $__env->make('purchase.partials.keyboard_shortcuts_details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>" data-html="true"
			data-trigger="hover" data-original-title="" title=""></i></h4>
                <ul class="breadcrumbs pull-left" style="margin-top: 15px">
                    <li><a href="#">Purchases</a></li>
                    <li><span><?php echo app('translator')->get('purchase.add_purchase_bulk'); ?></span></li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="content main-content-inner">
	...
	<?php echo Form::open(['url' => action('PurchaseController@savePurchaseBulk'), 'method' => 'post', 'id' =>
	'add_purchase_form',
	'files' => true ]); ?>
		...
		<div class="col-sm-12">
				...
				<table class="table table-condensed table-bordered table-th-green text-center table-striped"
					...
					<thead>
						<tr>
							...
							<th><?php echo app('translator')->get( 'product.units' ); ?></th>
							<th><?php echo app('translator')->get( 'purchase.purchase_quantity' ); ?></th>
							<?php if($enable_free_qty): ?>
							<th><?php echo app('translator')->get( 'purchase.free_qty' ); ?></th>
							<?php endif; ?>
							<th><?php echo app('translator')->get( 'purchase.available_qty' ); ?></th>
							...
							<th class="hide <?php if(!session('business.enable_editing_product_from_purchase')): ?> hide <?php endif; ?>">
							...
							<?php endif; ?>
							<th><?php echo app('translator')->get('purchase.invoice_no'); ?></th>
							<th><?php echo app('translator')->get('purchase.multiple_payment'); ?></th>
							<th><?php echo app('translator')->get('purchase.payment_amount'); ?></th>
			...
			<div class="col-md-12" style="font-size: 18px;">
				<table class="pull-right col-md-12">
					<tr class="hide">
						<th class="col-md-6 text-right"><?php echo app('translator')->get( 'purchase.total_before_tax' ); ?>:</th>
					...
					<tr>
						<th class="col-md-6 text-right"><?php echo app('translator')->get( 'purchase.total_amount' ); ?>:</th>
						<td class="col-md-5 text-left">
					...
					<tr class="text-red">
						<th class="col-md-6 text-right"><?php echo app('translator')->get( 'purchase.total_balance_due' ); ?>:</th>
						<td class="col-md-5 text-left">
	...
	<?php $__env->startComponent('components.widget', ['class' => 'box-primary hide']); ?>
	<div class="row">
		<div class="col-sm-12">
			<table class="table">
				<tr>
					<td class="col-md-3">
						<div class="form-group">
							...
							<?php echo Form::select('discount_type', [ '' => __('lang_v1.none'), 'fixed' => __( 'lang_v1.fixed'
						...
						<div class="form-group">
							...
							<select name="tax_id" id="tax_id" class="form-control select2"
								...
								<option value="<?php echo e($tax->id, false); ?>" data-tax_amount="<?php echo e($tax->amount, false); ?>"
									data-tax_type="<?php echo e($tax->calculation_type, false); ?>"><?php echo e($tax->name, false); ?></option>
...
<script src="<?php echo e(asset('js/purchase-bulk.js?v=' . $asset_v), false); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/resources/views/purchase/add_purchase_bulk.blade.php ENDPATH**/ ?>