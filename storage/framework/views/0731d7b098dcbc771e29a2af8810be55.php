     ...
     <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <?php echo Form::label('ref_no_prefixes[purchase]', __('lang_v1.purchase_order') . ':'); ?>
                 ...
                 <div class="input-group">
					<span class="input-group-addon">
						<?php echo app('translator')->get('lang_v1.prefix'); ?>
					</span>
                <?php echo Form::text('ref_no_prefixes[purchase]', $purchase_prefix, ['class' => 'form-control']); ?>
                 ...
                 <div class="input-group">
					<span class="input-group-addon">
						<?php echo app('translator')->get('lang_v1.starting_number'); ?>
					</span>
                <?php echo Form::text('ref_no_starting_number[purchase]', $purchase_starting_number, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <?php echo Form::text('ref_no_starting_number[purchase_return]',  $purchase_return_stating_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <?php echo Form::text('ref_no_starting_number[stock_transfer]', $stock_transfer_stating_number, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <?php echo Form::text('ref_no_starting_number[stock_adjustment]', $stock_adjustment_starting_number, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <?php echo Form::text('ref_no_starting_number[sell_return]',  $sell_return_starting_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <?php echo Form::text('ref_no_starting_number[expense]', $expenses_starting_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <?php echo Form::text('ref_no_starting_number[contacts]', $contacts_starting_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <?php echo Form::text('ref_no_starting_number[purchase_payment]', $purchase_payment_starting_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <?php echo Form::text('ref_no_starting_number[sell_payment]', $sell_payment_starting_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <?php echo Form::text('ref_no_starting_number[expense_payment]', $expense_payment_starting_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <?php echo Form::text('ref_no_starting_number[business_location]',  $business_location_starting_number, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <?php echo Form::text('ref_no_starting_number[username]',  $username_strating_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <?php echo Form::text('ref_no_starting_number[subscription]', $subscription_starting_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                ?>
                <?php echo Form::label('ref_no_prefixes[customer]', __('lang_v1.customer') . ':'); ?>
                ...
                <?php echo Form::text('ref_no_prefixes[customer]', $customer_prefix, ['class' => 'form-control']); ?>
                ...
                <?php echo Form::text('ref_no_starting_number[customer]', $customer_starting_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                ?>
                <?php echo Form::label('ref_no_prefixes[supplier]', __('lang_v1.supplier') . ':'); ?>

                <div class="input-group">
					<span class="input-group-addon">
						<?php echo app('translator')->get('lang_v1.prefix'); ?>
					</span>
                <?php echo Form::text('ref_no_prefixes[supplier]', $supplier_prefix, ['class' => 'form-control']); ?>
                ...
                <?php echo Form::text('ref_no_starting_number[supplier]', $supplier_starting_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                ?>
                <?php echo Form::label('ref_no_prefixes[settlement]', __('lang_v1.settlement') . ':'); ?>

                <div class="input-group">
					<span class="input-group-addon">
						<?php echo app('translator')->get('lang_v1.prefix'); ?>
					</span>
                <?php echo Form::text('ref_no_prefixes[settlement]', $settlement_prefix, ['class' => 'form-control']); ?>
                ...
                <?php echo Form::text('ref_no_starting_number[settlement]', $settlement_starting_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                ?>
                <?php echo Form::label('ref_no_prefixes[excess_commission]', __('lang_v1.excess_commission') . ':'); ?>

                <div class="input-group">
					<span class="input-group-addon">
						<?php echo app('translator')->get('lang_v1.prefix'); ?>
					</span>
                <?php echo Form::text('ref_no_prefixes[excess_commission]', $excess_commission_prefix, ['class' => 'form-control']); ?>
                ...
                <?php echo Form::text('ref_no_starting_number[excess_commission]', $excess_commission_starting_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                ?>
                <?php echo Form::label('ref_no_prefixes[shortage_recover]', __('lang_v1.shortage_recover') . ':'); ?>

                <div class="input-group">
					<span class="input-group-addon">
						<?php echo app('translator')->get('lang_v1.prefix'); ?>
					</span>
                <?php echo Form::text('ref_no_prefixes[shortage_recover]', $shortage_recover_prefix, ['class' => 'form-control']); ?>
                ...
                <?php echo Form::text('ref_no_starting_number[shortage_recover]', $shortage_recover_starting_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                ?>
                <?php echo Form::label('ref_no_prefixes[security_deposit]', __('lang_v1.security_deposit') . ':'); ?>

                <div class="input-group">
					<span class="input-group-addon">
						<?php echo app('translator')->get('lang_v1.prefix'); ?>
					</span>
                <?php echo Form::text('ref_no_prefixes[security_deposit]', $security_deposit_prefix, ['class' => 'form-control']); ?>
                ...
                <?php echo Form::text('ref_no_starting_number[security_deposit]', $security_deposit_starting_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                ?>
                <?php echo Form::label('ref_no_prefixes[refund_security_deposit]', __('lang_v1.refund_security_deposit') . ':'); ?>

                <div class="input-group">
					<span class="input-group-addon">
						<?php echo app('translator')->get('lang_v1.prefix'); ?>
					</span>
                <?php echo Form::text('ref_no_prefixes[refund_security_deposit]', $refund_security_deposit_prefix, ['class' => 'form-control']); ?>
                ...
                <?php echo Form::text('ref_no_starting_number[refund_security_deposit]', $refund_security_deposit_starting_no, ['class' => 'form-control']); ?>

                </div>
            </div>
        </div>
        <div class="col-sm-4  <?php if($get_permissions['fleet_module'] == 0): ?> hide  <?php endif; ?>">
            <div class="form-group">
                <?php
                ...
                ?>
                <?php echo Form::label('ref_no_prefixes[employee_no]', __('lang_v1.employee_no') . ':'); ?>

                <div class="input-group">
					<span class="input-group-addon">
						<?php echo app('translator')->get('lang_v1.prefix'); ?>
					</span>
                <?php echo Form::text('ref_no_prefixes[employee_no]', $employee_no_prefix, ['class' => 'form-control']); ?>
                ...
                <?php echo Form::text('ref_no_starting_number[employee_no]', $employee_no_starting_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4  <?php if($get_permissions['fleet_module'] == 0): ?> hide  <?php endif; ?>">
            <div class="form-group">
                ...
                ?>
                <?php echo Form::label('ref_no_prefixes[route_no]', __('lang_v1.route_no') . ':'); ?>

                <div class="input-group">
					<span class="input-group-addon">
						<?php echo app('translator')->get('lang_v1.prefix'); ?>
					</span>
                <?php echo Form::text('ref_no_prefixes[route_no]', $route_no_prefix, ['class' => 'form-control']); ?>
                ...
                <?php echo Form::text('ref_no_starting_number[route_no]', $route_no_starting_no, ['class' => 'form-control']); ?>
        ...
        <div class="col-sm-4 ">
            <div class="form-group">
                ...
                ?>
                <?php echo Form::label('ref_no_prefixes[quotation_no]', __('lang_v1.quotation') . ':'); ?>

                <div class="input-group">
					<span class="input-group-addon">
						<?php echo app('translator')->get('lang_v1.prefix'); ?>
					</span>
                <?php echo Form::text('ref_no_prefixes[quotation_no]', $quotation_no_prefix, ['class' => 'form-control']); ?>
                ...
                <?php echo Form::text('ref_no_starting_number[quotation_no]', $quotation_no_starting_no, ['class' => 'form-control']); ?>
...
</div><?php /**PATH /home/vimi31/public_html/resources/views/business/partials/settings_prefixes.blade.php ENDPATH**/ ?>