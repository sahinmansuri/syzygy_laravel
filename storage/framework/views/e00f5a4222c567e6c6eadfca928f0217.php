<?php $__env->startSection('title', __('mpcs::lang.form_set_1')); ?>
        ...
        <div class="col-md-12">
            <div class="settlement_tabs">
                <ul class="nav nav-tabs">
                    <?php if(auth()->user()->can('f9c_form')): ?>
                    <li class="active">
                        <a href="#9c_form_tab" class="9c_form_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.9c_form'); ?></strong>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if(auth()->user()->can('f15a9abc_form')): ?>
                    <li class="">
                        <a href="#15a9ab_form_tab" class="15a9ab_form_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.15a9ab_form'); ?></strong>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if(auth()->user()->can('f15a9abc_form')): ?>
                    <li class="">
                        <a href="#9b_form_tab" class="9b_form_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.9b_form'); ?></strong>
                        </a>
                    </li>
                    <?php endif; ?>
                   
                    <!--<?php if(auth()->user()->can('f21c_form')): ?>-->
                    <!--<li class="">-->
                    <!--    <a href="#21c_form_tab" class="21c_form_tab" data-toggle="tab">-->
                    <!--        <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.21c_form'); ?></strong>-->
                    <!--    </a>-->
                    <!--</li>-->
                    <!--<?php endif; ?>-->
                </ul>
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="9c_form_tab">
                        <?php echo $__env->make('mpcs::forms.partials.9c_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endif; ?>
                    <?php if(auth()->user()->can('f15a9abc_form')): ?>
                    <div class="tab-pane" id="15a9ab_form_tab">
                        <?php echo $__env->make('mpcs::forms.partials.15a9ab_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endif; ?>
                    <?php if(auth()->user()->can('f15a9abc_form')): ?>
                    <div class="tab-pane" id="9b_form_tab">
                        <?php echo $__env->make('mpcs::forms.partials.9b_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endif; ?>
                   
                    <?php if(auth()->user()->can('f21c_form')): ?>
                    <div class="tab-pane" id="21c_form_tab">
                        <?php echo $__env->make('mpcs::forms.partials.21c_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endif; ?>
...
<script type="text/javascript">
    ...
    function get_previous_value_9c(){
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                var this_page_qty_<?php echo e($sub_cat->id, false); ?> = __read_number_from_text($('#footer_f9c_qty_this_page_<?php echo e($sub_cat->id, false); ?>'));
                var this_page_amount_<?php echo e($sub_cat->id, false); ?> = __read_number_from_text($('#footer_f9c_amount_this_page_<?php echo e($sub_cat->id, false); ?>'));
                
                var pre_page_qty_<?php echo e($sub_cat->id, false); ?> = __read_number_from_text($('#footer_f9c_qty_pre_page_<?php echo e($sub_cat->id, false); ?>'));
                var pre_page_amount_<?php echo e($sub_cat->id, false); ?> = __read_number_from_text($('#footer_f9c_amount_pre_page_<?php echo e($sub_cat->id, false); ?>'));

                var grand_total_qty_<?php echo e($sub_cat->id, false); ?> = this_page_qty_<?php echo e($sub_cat->id, false); ?> + pre_page_qty_<?php echo e($sub_cat->id, false); ?>;
                var grand_total_amount_<?php echo e($sub_cat->id, false); ?> = this_page_amount_<?php echo e($sub_cat->id, false); ?> + pre_page_amount_<?php echo e($sub_cat->id, false); ?>;
               
                $('#footer_f9c_qty_grand_<?php echo e($sub_cat->id, false); ?>').text(__number_f(grand_total_qty_<?php echo e($sub_cat->id, false); ?>, false, false, __currency_precision));
                $('#footer_f9c_amount_grand_<?php echo e($sub_cat->id, false); ?>').text(__number_f(grand_total_amount_<?php echo e($sub_cat->id, false); ?>, false, false, __currency_precision));
    ...
    function get_this_page_total_9c(){
        ...
        var total_qty_<?php echo e($item->id, false); ?> = sum_table_col($('#form_9c_table'), '<?php echo e($item->id, false); ?>_qty');
        $('#footer_f9c_qty_this_page_<?php echo e($item->id, false); ?>').text(__number_f(total_qty_<?php echo e($item->id, false); ?> , false, false, __currency_precision));
        var total_amount_<?php echo e($item->id, false); ?> = sum_table_col($('#form_9c_table'), '<?php echo e($item->id, false); ?>_amount');
        $('#footer_f9c_amount_this_page_<?php echo e($item->id, false); ?>').text(__number_f(total_amount_<?php echo e($item->id, false); ?> , false, false, __currency_precision));
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    function caculateF16AFromTotal(){
        var total_purchase_price = <?php if(optional($setting)->F16A_first_day_after_stock_taking == 1): ?> 0 <?php else: ?> sum_table_col($('#form_16a_table'), 'total_purchase_price') <?php endif; ?>;
        $('#footer_F16A_total_purchase_price').text(__number_f(total_purchase_price, false, false, __currency_precision));
        var total_sale_price =  <?php if(optional($setting)->F16A_first_day_after_stock_taking == 1): ?> 0 <?php else: ?> sum_table_col($('#form_16a_table'), 'total_sale_price') <?php endif; ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/Modules/MPCS/Providers/../Resources/views/forms/form_set_1.blade.php ENDPATH**/ ?>