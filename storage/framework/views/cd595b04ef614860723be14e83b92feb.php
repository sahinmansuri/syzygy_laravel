...
<script src="<?php echo e(asset('AdminLTE/plugins/select2/js/select2.full.min.js?'), false); ?>"></script>
<!-- CSS file -->
<style>
    .remove-border {
    ...
    .select2{
        ...
        <?php echo $__env->make('web.ad', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="mt-10  pb-6 w-full lg:w-1/2">
                <div class="max-w-md mx-auto">
                    <div class="mb-6 lg:mb-20 w-full px-3 flex items-center justify-between" style="margin-bottom: 10px !important;">
                            ...
                            href="<?php echo e(url('index'), false); ?>">Landing Page</a>&nbsp;
                            ...
                            href="#"><?php echo e(__('Login .'), false); ?></a>&nbsp;
                            
                        
                            <a data-toggle="modal" data-target="#check_register_type_modal"
                            class="py-2 px-6 text-xs rounded-l-xl rounded-t-xl bg-<?php echo e($config[11]->config_value, false); ?>-600 hover:bg-<?php echo e($config[11]->config_value, false); ?>-700 text-white font-bold transition duration-200"
                            href="#"><?php echo e(__('Sign Up'), false); ?></a>&nbsp;
                            
                            </div>
                    <div>
                        <div class="mb-6 px-3">
                            <span class="text-gray-500"><?php echo e(__('Sign In'), false); ?></span>
                            <h3 class="text-2xl font-bold"><?php echo e(__('Sign in your account'), false); ?></h3>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                        <form method="POST" action="<?php echo e(route('login'), false); ?>" id="login_form">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3 flex p-4 mx-2 bg-gray-200 rounded">
                                <input class="w-full text-xs bg-gray-200 outline-none <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                    id="email" type="text" placeholder="<?php echo e(__('name@email.com'), false); ?>" name="username"
                                    value="<?php echo e(old('email'), false); ?>" <?php echo e($required, false); ?> autocomplete="email" autofocus>
                            ...
                            <div class="mb-2 flex p-4 mx-2 bg-gray-200 rounded">
                                <input
                                    class="w-full text-xs bg-gray-200 outline-none <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    id="password" type="password" placeholder="<?php echo e(__('Enter your password'), false); ?>"
                                    name="password" <?php echo e($required, false); ?> autocomplete="current-password">
                            ...
                            <div class="px-3 text-center">
                                <button
                                    class="mb-2 w-full py-4 bg-<?php echo e($config[11]->config_value, false); ?>-600 shadow-lg hover:bg-<?php echo e($config[11]->config_value, false); ?>-700 rounded text-sm font-bold text-gray-50 transition duration-200"><?php echo e(__('Sign In'), false); ?></button>
    
                                
                                <span class="text-gray-400 text-xs">
                                    <span><?php echo e(__('If you do not have an account?'), false); ?></span>
                                    <a data-toggle="modal" data-target="#check_register_type_modal" class="text-<?php echo e($config[11]->config_value, false); ?>-600 hover:underline  signup-button"
                                        href="#"><?php echo e(__('Sign Up'), false); ?></a>
                                </span>
                            </div>
                        </form>
            ...
            <div class="hidden lg:block relative w-full lg:w-1/2 ">
                <div class="absolute bottom-0 inset-x-0 mx-auto mb-12 max-w-xl text-center authentication">
                        ...
                        <?php if($file_exists): ?>
                            <img class="lg:max-w-xl mx-auto" src="<?php echo e($file_url, false); ?>" alt="<?php echo e($config[0]->config_value, false); ?>">
                        <?php endif; ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="col-md-12">
                    <?php echo Form::label('check_register_type', 'Plesae select the register type', ['style' => 'color: black
                    !important;']); ?>

                    <?php echo Form::select('check_register_type', $user_types, null, ['class' => 'form-control',
...
<div class="modal fade" id="pumper_choose_business" tabindex="-1"  role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="col-md-12">
                    <input type="hidden" id="business_count" value="<?php echo e(sizeof($businesses), false); ?>">
                    <?php
                    ...
                    ?>
                    <?php echo Form::label('pumper_business_id', 'Choose your Business', ['style' => 'color: black
                    !important;']); ?>

                    <?php echo Form::select('pumper_business_id', $businessesFormatted, null, ['class' => 'form-control',
                    'style' => 'width: 100%;', 'id' => 'pumper_business_id', 'placeholder' =>
                    __('lang_v1.please_select')]); ?>

                    <?php echo Form::label('login_display', 'Choose your Login Display', ['style' => 'color: black
                    !important; display: none;', 'class' => 'login_display']); ?>

                    <?php echo Form::select('login_display', $choose_login_display, null, ['class' => 'form-control login_display',
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <span class="modal-title" id="exampleModalLongTitle"><?php echo e(__('repair::lang.repair_status'), false); ?></span>
...
<div class="modal fade"  id='vehicle_register' tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content"  style="padding: 30px; overflow-y: auto; height: 80vh">
      <div class="col-lg-12">
                            <form method="POST" action="<?php echo e(route('vehicle.store'), false); ?>">
                                <?php echo Form::token(); ?>   
                                
                                <?php echo $__env->make('petro::vehicle.register', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo Form::close(); ?>
...
<div class="modal fade"  id="visitor_register_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content"  style="padding: 30px; overflow-y: auto; height: 80vh">
      <?php echo Form::open(['url' => route('business.postVisitorRegister'), 'method' => 'post',
                        'id' => 'visitor_register_form','files' => true ]); ?>
                            ...
                            <?php echo $__env->make('business.partials.register_form_visitor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <p></p>
                            <hr>
...
<div class="modal fade"  id="self_verification_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content"  style="padding: 30px; overflow-y: auto;">
            <?php echo Form::open(['url' => 'process/verify', 'method' => 'post',
            'id' => 'verification_form' ]); ?>

            <?php echo $__env->make('auth.verification', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo Form::close(); ?>
...
<div class="modal fade"  id="cust_reg_modal"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content" style="padding: 30px; overflow-y: auto; height: 80vh">
      <p class="form-header"><?php echo app('translator')->get('business.register_and_get_started_in_minutes'); ?></p>
                                    <?php echo Form::open(['url' => route('business.customer_register'), 'method' => 'post',
                                    'id' => 'customer_register_form','files' => true ]); ?>

                                    <?php echo $__env->make('business.partials.customer_register', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php echo Form::hidden('package_id', $package_id); ?>
...
<div class="modal fade"  id="member_register_modal"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content" style="padding: 30px; overflow-y: auto; height: 80vh">
      <p class="form-header"><?php echo app('translator')->get('business.member_registration'); ?></p>
        <?php echo Form::open(['url' => route('business.member_register'), 'method' => 'post','id' => 'member_register_form','files' => true ]); ?>

        <?php echo $__env->make('business.partials.member_register', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo Form::close(); ?>
...
<div class="modal fade" id="patient_register_modal"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content"  style="padding: 30px; overflow-y: auto; height: 80vh">
        <h2 class="form-header"><?php echo app('translator')->get('business.my_health_register'); ?></h2>
                                    <?php echo Form::open(['url' => route('business.postPatientRegister'), 'method' => 'post',
                                    'id' => 'patient_register_form','files' => true ]); ?>

                                    <?php echo $__env->make('business.partials.register_form_patient', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php echo Form::hidden('package_id', $package_id, ['class' => 'package_id']); ?>
...
<div class="modal fade" id="agent_register_modal"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content"  style="padding: 30px; overflow-y: auto; height: 80vh">
        <h2 class="form-header"><?php echo app('translator')->get('superadmin::lang.agent_registration'); ?></h2>
                                    <?php echo Form::open(['url' => route('business.postAgentRegister'), 'method' => 'post',
                                    'id' => 'agent_register_form','files' => true ]); ?>

                                    <?php echo $__env->make('business.partials.register_form_agent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<div class="modal fade" id="self_registration_modal"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content"  style="padding: 30px; overflow-y: auto; height: 80vh">
        <p class="form-header"><?php echo app('translator')->get('lang_v1.self_registration'); ?></p>
                                    
                                    <?php echo Form::open(['url' => '/visitor/register', 'method' => 'post',
                                    'id' => 'self_registration_form','files' => true ]); ?>

                                    <?php echo $__env->make('visitor::visitor_registration.self_registration', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php echo Form::close(); ?>
...
<?php if(!empty($show_message->lp_captcha)): ?> 
    <?php if($show_message->lp_captcha == 1): ?>
        <?php if(!empty($business_settings->captch_site_key)): ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('change', '#pumper_business_id',function(){
            ...
            if(pumper_business_id){
                $(".login_display").show();
                // window.location.href = '<?php echo e(url("/pump-operator/login"), false); ?>?cc='+pumper_business_id;
            } else {
                $(".login_display").hide();
            }
            
        });
        const businessesData = JSON.parse(<?php echo json_encode($businessesJson, 15, 512) ?>);
        ...
        $(document).on('change', '#login_display',function(){
            ...
            if(pumper_business_id){
                ...
                if(login_display && login_display == "petro_module"){
                    ...
                    if(patient_module){
                        window.location.href = '<?php echo e(url("/patient/login"), false); ?>?cc='+pumper_business_id;
                    } else {
                    ...
                    if(employee){
                        window.location.href = '<?php echo e(url("/employee/login"), false); ?>?cc='+pumper_business_id;
                    } else {
                    ...
                    if(shipping_module){
                        window.location.href = '<?php echo e(url("/shipping/login"), false); ?>?cc='+pumper_business_id;
                    } else {
                    ...
                    if(sale_module){
                        window.location.href = '<?php echo e(url("/project/login"), false); ?>?cc='+pumper_business_id;
                    } else {
                    ...
                    if(bakery_module){
                        window.location.href = '<?php echo e(url("/backery/login"), false); ?>?cc='+pumper_business_id;
                    } else {
        ...
        $(document).on('change', '#email',function(){
            ...
            $.ajax({
                type: "post",
                url: "<?php echo e(url('reCAPCHA/install'), false); ?>",
                data: {
                    "user_name" : username
                },
                dataType: "json",
        ...
        $(document).on('click','.resend-opt',function(e) {
            ...
            $.ajax({
                type: "get",
                url: "<?php echo e(action('UsersOPTController@resendOpt'), false); ?>",
                dataType: "json",
                success: function (result) {
                    if(result.status){
        ...
        //     pumper_business_id = "<?php echo e($businesses->keys()->first(), false); ?>";
    ...
    $(document).ready(function () {
        <?php if(session('status')): ?>
            var status = <?php echo json_encode(session('status'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.web', ['nav' => false, 'banner' => false, 'footer' => false, 'cookie' => false, 'setting' => true,
'title' => true, 'title' => __('Sign In')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>