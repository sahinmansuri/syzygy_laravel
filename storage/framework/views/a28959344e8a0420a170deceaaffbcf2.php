...
if(!isset($is_ajax)){
    ...
    <?php $__env->startSection('title', __('mpcs::lang.F21_form')); ?>
               ...
               <ul class="nav nav-tabs">
                    ...
                    <li class="active">
                        <a href="#21c_form_tab" class="21c_form_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.21_c_form_details'); ?></strong>
                        </a>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="">
                        <a href="#21c_form_list_tab" class="21c_form_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.21_c_form_settings'); ?></strong>
                        </a>
                    </li>
                    <?php endif; ?>
               </ul>        
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="21c_form_tab">
                        <?php echo $__env->make('mpcs::forms.21CForm.21c_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endif; ?>
                    <?php if(auth()->user()->can('F21_form')): ?>
                    <div class="tab-pane" id="21c_form_list_tab">
                          <?php echo $__env->make('mpcs::forms.21CForm.list_f21c', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endif; ?>
...
<?php if(empty($is_ajax)): ?>
    <?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/Modules/MPCS/Providers/../Resources/views/forms/21CForm/F21_form.blade.php ENDPATH**/ ?>