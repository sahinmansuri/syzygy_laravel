                ...
                <div class="row" style="margin-top: 20px;" id="print_content">
                      <table width="100%" style="margin-top: 0px;" class="no-border-table">
                                <tr style="border: none;">
                                    ...
                                    <!--<td align="left" width="35%" style="border: none;"><h3></h3></td>-->
                                    <td align="left" width="15%" style="border: none;"><h2 style="color: gray;">Form 9 C</h2></td>
            ...
            <div class="box-tools">
                ...
                <button class="btn btn-primary print_report pull-right" id="print_div">
                    ...
                    <table width="100%" style="margin-top: 10px;" class="no-border-table">
                                <tr style="border: none;">
                                    <td align="right" width="40%" style="border: none;">    </td>
                                    <td align="left" width="35%" style="border: none;"><h3><?php echo e($business_location_name, false); ?></h3></td>
                                    
                                    <td align="center" width="20%" style="border: none;"><h3>Form No:<?php echo e($form_9a_no, false); ?><h3></td>
                    ...
                    <div class="col-md-12" style="margin-top: 20px;">
                        ...
                        <h3><?php echo app('translator')->get('mpcs::lang.credit_sales_details'); ?></h3>
                    </div>
                    <table width="100%" style="margin-top: 0px;" class="no-border-table">
                                <tr style="border: none;">
                   ...
                   <?php echo Form::date('datepicker', date('Y-m-d'), [
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                   ...
                                   <table class="table table-bordered table-striped" id="form_9ccr_table">
                                        <thead class="align-middle">
                                            <tr class="align-middle text-center">
                                                <th class="align-middle text-center" rowspan="2"><?php echo app('translator')->get('mpcs::lang.bill_no'); ?></th>
                                                <th class="align-middle text-center" rowspan="2"><?php echo app('translator')->get('mpcs::lang.product_name'); ?></th>
                                                <th class="align-middle text-center" rowspan="2"><?php echo app('translator')->get('mpcs::lang.qty'); ?></th>
                                                <th class="align-middle text-center" rowspan="2"><?php echo app('translator')->get('mpcs::lang.page'); ?></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th colspan="3">The Previous Note Total </th>
                                ...
                                <tr style="border: none;">
                                    <td align="center" width="25%" style="border: none;">Entered in the Book</td>
                                    <td align="center" width="25%" style="border: none;">.............................. <br> Checked By</td>
                                    <td align="center" width="25%" style="border: none;">.............................. <br> Manager</td>
                                     <td align="center" width="25%" style="border: none;"> 
                                     
                                      <td align="center" width="25%" style="border: none;"> <button class="btn btn-primary print_report pull-right" id="print_divs">
                            ...
                            <table width="100%" style="margin-top: 20px;"   class="no-border-table" style="border: 0px solid white;">
...
<!-- /.content --><?php /**PATH /home/vimi31/public_html/Modules/MPCS/Providers/../Resources/views/forms/partials/9ccr_form.blade.php ENDPATH**/ ?>