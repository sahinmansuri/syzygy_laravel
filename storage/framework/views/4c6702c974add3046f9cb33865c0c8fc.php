...
<div class="container no-print">
  <?php echo $__env->make('petro::pump_operators.partials.payment_section', ['pop_up' => false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title"><?php echo app('translator')->get( 'petro::lang.credit_sale' ); ?></h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>

        <!-- Modal Body -->
        <div class="modal-body">
            <?php echo $__env->make('petro::pump_operators.credit_sale', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
 ...
 <div class="modal fade" id="cheque_payments" role="dialog" 
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title"><?php echo app('translator')->get( 'petro::lang.cheque' ); ?></h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>

        <!-- Modal Body -->
        <div class="modal-body">
            <?php echo $__env->make('petro::pump_operators.cheque_payment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
  ...
  <div class="modal fade" id="cash_payments" role="dialog" 
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title"><?php echo app('translator')->get( 'petro::lang.cash' ); ?></h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>

        <!-- Modal Body -->
        <div class="modal-body">
            <?php echo Form::open(['url' => action('\Modules\Petro\Http\Controllers\PumpOperatorPaymentController@saveCashDenom'), 'method' =>'post']); ?>

            <div class="row">
                <div class="col-md-6">
                    <?php $__currentLoopData = $cash_denoms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $denom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    
                        <div class="row">
                            <input type="hidden" value="<?php echo e($denom, false); ?>" class="denom_value">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label><?php echo e(number_format($denom,  2, session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?></label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo Form::number('qty[]', 0, ['class' => 'form-control cash_payment_input denom_qty', 'required',
                                    'placeholder' => __(
                                    'petro::lang.qty' ) ]); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo Form::text('total_amount[]', 0, ['class' => 'form-control denom_amt', 'required','readonly',
                                    'placeholder' => __(
                    ...
                    <div class="row denoms_totals">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label><?php echo e(__( 'lang_v1.total' ), false); ?></label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?php echo Form::text('grand_total', 0, ['class' => 'form-control denom_total', 'required','readonly',
                                'placeholder' => __(
                        ...
                        <div class="col-md-2 pull-right">
                            <button type="submit" class="btn btn-success pull-right other_sale_finalize"
                                style="margin-top: 23px;"><?php echo app('translator')->get('petro::lang.correct'); ?></button>
                        </div> 
...
<div class="modal fade" id="card_payment" role="dialog" 
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title"><?php echo app('translator')->get('petro::lang.card'); ?></h4>
          <button type="button" class="btn btn-primary pull-right" data-dismiss="modal">&times;</button>
        </div>

        <!-- Modal Body -->
        <div class="modal-body">
            <?php echo $__env->make('petro::pump_operators.card_payment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
  ...
  <div class="modal fade" id="other_sales" role="dialog" 
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title"><?php echo app('translator')->get('petro::lang.enter_meters'); ?></h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>

        <!-- Modal Body -->
        <div class="modal-body">
            <?php echo $__env->make('petro::pump_operators.other_sales',compact('pending_pumps'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
<script src="<?php echo e(url('Modules/Petro/Resources/assets/js/po_payment.js'), false); ?>?v=<?php echo e(time(), false); ?>"></script>
<script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.'.$layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/Modules/Petro/Providers/../Resources/views/pump_operators/actions/payments.blade.php ENDPATH**/ ?>