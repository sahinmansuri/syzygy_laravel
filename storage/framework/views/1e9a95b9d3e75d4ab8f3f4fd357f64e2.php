...
<div class="col-md-12" style="">
    ...
    <div class="col-md-12">
        <div class="form-group">
            <?php echo Form::label('v_name', __('business.business_name') . ':' ); ?>

            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-suitcase"></i>
                </span>
                <?php echo Form::text('name', null, ['class' => 'form-control','placeholder' => __('business.business_name'),
    ...
    <div class="col-md-6">
        <div class="form-group">
            <?php echo Form::label('r_f_v_mobile', __('lang_v1.business_telephone') . ':'); ?>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <?php echo Form::label('visitor_username', __('business.username') . ':'); ?>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <?php echo Form::label('visitor_email', __('business.email') . ':'); ?>

            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-envelope"></i>
                </span>
                <?php echo Form::text('email', null, ['class' => 'form-control', 'id' => 'visitor_email', 'placeholder' =>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <?php echo Form::label('visitor_password', __('business.password') . ':'); ?>

            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-lock"></i>
                </span>
                <?php echo Form::password('password', ['class' => 'form-control','placeholder' => __('business.password'), 'id'
                => 'visitor_password',
    ...
    <div class="col-md-6">
        <div class="form-group">
            <?php echo Form::label('visitor_confirm_password', __('business.confirm_password') . ':'); ?>
    ...
    <?php if(in_array('visitor', $show_referrals_in_register_page )): ?>
    <div class="col-md-6">
        <div class="form-group">
    ...
    <?php endif; ?>
    <?php if(in_array('visitor', $show_give_away_gift_in_register_page )): ?>
    <div class="col-md-6">
        <div class="form-group">
            <?php echo Form::label('give_away_gifts', __('superadmin::lang.give_away_gifts') . ':'); ?>
            ...
            <div class="checkbox">
                <label>
                    <?php echo Form::checkbox('give_away_gifts[]', $key, false, ['class' => '', 'id'=>'give_away_gifts']); ?> <?php echo e($give_away_gift, false); ?>
...
</div><?php /**PATH /home/vimi31/public_html/resources/views/business/partials/register_form_visitor.blade.php ENDPATH**/ ?>