        ...
        <div class="modal-body body2">
                ...
                <div class="col-md-4">
                     <div class="form-group">
                       <small>First Name:*</small>
                        <input type="text" name="join_date" id="join_date" value="<?php echo e(date('Y-m-d', time()), false); ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 p-0 custom_date_p-0" style="margin-right: 20px;">
                                            ...
                                            <div class="field-inline-block w-100 text-center">
                                                <input type="text" pattern="[0-9]*" maxlength="1" class="custom_date_date-field form-control d-inline-block" placeholder="D" id="custom_date_from_date1" required value="<?php echo e($dayDigits[0] ?? '', false); ?>" style="width: 40px; display: inline-block; margin-right: 2px;">
                                                <input type="text" pattern="[0-9]*" maxlength="1" class="custom_date_date-field form-control d-inline-block" placeholder="D" id="custom_date_from_date2" required value="<?php echo e($dayDigits[1] ?? '', false); ?>" style="width: 40px; display: inline-block;">
                                            </div>
                                        </div>
                                        <div class="col-md-3 p-0 custom_date_p-0" style="margin-right: 20px;">
                                            <label class="text-center" style="color: #4d4d4d !important">Month</label>
                                            <div class="field-inline-block w-100 text-center">
                                                <input type="text" pattern="[0-9]*" maxlength="1" class="custom_date_date-field form-control d-inline-block" placeholder="M" id="custom_date_from_month1" required value="<?php echo e($monthDigits[0] ?? '', false); ?>" style="width: 40px; display: inline-block; margin-right: 2px;">
                                                <input type="text" pattern="[0-9]*" maxlength="1" class="custom_date_date-field form-control d-inline-block" placeholder="M" id="custom_date_from_month2" required value="<?php echo e($monthDigits[1] ?? '', false); ?>" style="width: 40px; display: inline-block;">
                                            </div>
                                        </div>
                                        <div class="col-md-4 p-0 custom_date_p-0">
                                            <label class="text-center" style="color: #4d4d4d !important">Year</label>
                                            <div class="field-inline-block w-100 text-center">
                                                <input type="text" pattern="[0-9]*" maxlength="1" class="custom_date_date-field form-control d-inline" placeholder="Y" id="custom_date_from_year1" required value="<?php echo e($yearDigits[0] ?? '', false); ?>" style="width: 40px; display: inline-block; margin-right: 2px;">
                                                <input type="text" pattern="[0-9]*" maxlength="1" class="custom_date_date-field form-control d-inline" placeholder="Y" id="custom_date_from_year2" required value="<?php echo e($yearDigits[1] ?? '', false); ?>" style="width: 40px; display: inline-block; margin-right: 2px;">
                                                <input type="text" pattern="[0-9]*" maxlength="1" class="custom_date_date-field form-control d-inline" placeholder="Y" id="custom_date_from_year3" required value="<?php echo e($yearDigits[2] ?? '', false); ?>" style="width: 40px; display: inline-block; margin-right: 2px;">
                                                <input type="text" pattern="[0-9]*" maxlength="1" class="custom_date_date-field form-control d-inline" placeholder="Y" id="custom_date_from_year4" required value="<?php echo e($yearDigits[3] ?? '', false); ?>" style="width: 40px; display: inline-block;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4" style="padding-left: 0px;">
                    ...
                    <?php if(in_array('my_health', $show_referrals_in_register_page )): ?>
                    <div class="form-group col-md-4">
                    ...
                    <div class="col-md-8">
                        ...
                        <?php if(in_array('my_health', $show_give_away_gift_in_register_page )): ?>
                        <div class="col-md-6">
                            <div class="form-group">
                                <?php echo Form::label('r_give_away_gifts', __('superadmin::lang.give_away_gifts') . ':'); ?>
                                ...
                                <div class="checkbox">
                                    <small>
                                        <?php echo Form::checkbox('give_away_gifts[]', $key, false, ['class' => '', 'id' => "r_give_away_gifts"]); ?> <?php echo e($give_away_gift, false); ?>
...
<?php /**PATH /home/vimi31/public_html/resources/views/business/partials/register_form_patient.blade.php ENDPATH**/ ?>