<?php $__env->startSection('title', __('mpcs::lang.F22StockTaking_form')); ?>

<?php $__env->startSection('content'); ?>

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1> <?php echo app('translator')->get('mpcs::lang.F22StockTaking_form'); ?>
        <small><?php echo app('translator')->get( 'mpcs::lang.F22StockTaking_form', ['contacts' => __('mpcs::lang.mange_F22StockTaking_form')
            ]); ?></small>
    </h1>
</section>
            ...
            <div class="settlement_tabs">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#f22_form_tab" class="f22_form_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.f22_form'); ?></strong>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#f22_last_verified_stock_tab" class="f22_last_verified_stock_tab" style=""
                            ...
                            <i class="fa fa-check"></i> <strong>
                                <?php echo app('translator')->get('mpcs::lang.f22_last_verified_stock'); ?> </strong>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#list_f22_stock_taking_tab" class="list_f22_stock_taking_tab" style=""
                            ...
                            <i class="fa fa-sign-in"></i> <strong>
                                <?php echo app('translator')->get('mpcs::lang.list_f22_stock_taking'); ?> </strong>
                        </a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="f22_form_tab">
                        <?php echo $__env->make('mpcs::forms.F22.partials.f22_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>

                    <div class="tab-pane" id="f22_last_verified_stock_tab">
                        <?php echo $__env->make('mpcs::forms.F22.partials.f22_last_verified_stock', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>

                    <div class="tab-pane" id="list_f22_stock_taking_tab">
                        <?php echo $__env->make('mpcs::forms.F22.partials.list_f22_stock_taking', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function(){
    ...
    var pre_gspage_totals = [];
     ...
     form_22_table = $('#form_22_table').DataTable({
        ...
        serverSide: false,
        lengthChange: false,
        pageLength: <?php echo e(!empty($settings->F22_no_of_product_per_page) ? $settings->F22_no_of_product_per_page : 25, false); ?>,
        columnDefs: [ {
            "targets": 0,
            "orderable": false,
        },
...
function printPage(content) {
		...
		w.print();
		w.close();
        window.location.href = "<?php echo e(URL::to('/'), false); ?>/mpcs/F22_stock_taking";
	}
function onlyPrintPage(content) {
		var w = window.open('', '_blank');
		$(w.document.body).html(`<?php echo $__env->make('layouts.partials.css', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>` + content);
		w.print();
		w.close();
        return false;
	}
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/Modules/MPCS/Providers/../Resources/views/forms/F22/F22_stock_taking.blade.php ENDPATH**/ ?>