...
<div class="pos-tab-content">
    <div class="container-xl">
        ...
        <div class="mb-3">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h2 class="page-title">
                        <?php echo e(__('Extra Cost'), false); ?>
                ...
                <div class="col-lg-6  mt-10">
                    <button type="button" onclick="addExtraCost()" class="btn btn-primary pull-right mt-10" aria-label="Left Align">
                        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> <?php echo e(__('Add Extra Cost'), false); ?>
            ...
            <div class="modal-content main-modal">
                ...
                <form id="mfg_extracost_form" action="javascript:saveExtraCost();" method="post">
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <?php echo Form::label('extracost_name', __( 'Extra Cost Name' ) . ':*'); ?>

                                <?php echo Form::text('extracost_name', '', ['id'=>'extracost_name','class' => 'form-control', 'required', 'placeholder' => __(
                                'Extra Cost Name' )]); ?>
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="submitExtraCost()" class="btn btn-primary"><?php echo app('translator')->get( 'messages.save' ); ?></button>
    ...
    <script type="text/javascript">
        ...
        function buildExtraCostTable() {
            ...
            ajax: {
                url: "<?php echo e(action('\Modules\Manufacturing\Http\Controllers\SettingsController@getExtraCost'), false); ?>",
            },
            columns: [
                { data: 'date', name: 'date' },
                { data: 'name', name: 'name' },
        ...
        function saveExtraCost() {
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route("saveExtraCost"), false); ?>',
                data: {
...
</div><?php /**PATH /home/vimi31/public_html/Modules/Manufacturing/Providers/../Resources/views/settings/partials/extra_cost.blade.php ENDPATH**/ ?>