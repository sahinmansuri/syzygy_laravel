					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<?php echo Form::select('product_list[]', [], null, ['class' => 'form-control product_select', 'placeholder' => __('messages.please_select'), 'required', 'style' => 'width: 100%;']); ?>

							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
							<?php if(isset($unit_html)): ?>
								<div class=" <?php if(!is_array($unit_html)): ?> input-group <?php else: ?> input_inline <?php endif; ?>">
									<?php echo Form::number('output_qty[]', 0, ['class' => "form-control"]); ?>
									...
									<span class="<?php if(!is_array($unit_html)): ?> input-group-addon <?php endif; ?>">
										...
										<select name="by_product_sub_unit_id[]" class="form-control">
											...
											<option value="<?php echo e($key, false); ?>" data-multiplier="<?php echo e($value['multiplier'], false); ?>" <?php if(!empty($recipe->sub_unit_id) && $recipe->sub_unit_id == $key): ?>
												selected
												<?php endif; ?>
...
</script><?php /**PATH /home/vimi31/public_html/Modules/Manufacturing/Providers/../Resources/views/layouts/partials/common_script.blade.php ENDPATH**/ ?>