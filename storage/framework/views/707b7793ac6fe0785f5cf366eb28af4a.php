<?php $__env->startSection('title', __('lang_v1.post_dated_cheques')); ?>
        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left"><?php echo app('translator')->get('lang_v1.post_dated_cheques'); ?></h4>
                    <ul class="breadcrumbs pull-left" style="margin-top: 15px">
                        <li><a href="<?php echo e(action('PostdatedChequeController@index'), false); ?>"><?php echo app('translator')->get('lang_v1.post_dated_cheques'); ?></a></li>
                        <li><span></span><?php echo app('translator')->get( 'contact.manage_your_contact', ['contacts' => __('lang_v1.post_dated_cheques') ]); ?></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <li class="<?php if(empty(session('status.tab'))): ?> active <?php endif; ?>">
                    <a href="#post_dated_cheques" data-toggle="tab">
                        <i class="fa fa-list"></i> <strong>
                            <?php echo app('translator')->get('lang_v1.post_dated_cheques'); ?> </strong>
                    </a>
                </li>
                <li class=" <?php if(session('status.tab') == 'old_post_dated_cheques'): ?> active <?php endif; ?>">
                    <a href="#old_post_dated_cheques" data-toggle="tab">
                        <i class="fa fa-list"></i> <strong>
                            <?php echo app('translator')->get('lang_v1.old_post_dated_cheques'); ?> </strong>
                    </a>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane <?php if(empty(session('status.tab'))): ?> active <?php endif; ?>"
                id="post_dated_cheques">
                    <?php echo $__env->make('postdated_cheques.postdated_cheques', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <div class="tab-pane <?php if(session('status.tab') == 'old_post_dated_cheques'): ?> active <?php endif; ?>"
                id="old_post_dated_cheques">
                        <?php echo $__env->make('postdated_cheques.old_postdated_cheques', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </section>
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        customer_id.append($('<option>', {
                                value: "",
                                text: "<?php echo e(__('lang_v1.all'), false); ?>"
                            }));
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/resources/views/postdated_cheques/index.blade.php ENDPATH**/ ?>