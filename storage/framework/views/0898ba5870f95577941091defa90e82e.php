	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
						...
						<div class="row">
							<div id="payment_rows_div">
								...
								<?php $__currentLoopData = $payment_lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment_line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									<?php echo $__env->make('sale_pos.partials.payment_row', ['removable' => !$loop->first, 'row_index' => !empty($loop->index) ? $loop->index : 0, 'payment_line' => $payment_line, 'payment' => (object) $payment_line], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<?php echo Form::textarea('sale_note',!empty($temp_data->sale_note)?$temp_data->sale_note: (!empty($transaction)? $transaction->additional_notes:null), ['class' => 'form-control', 'rows' => 3, 'placeholder' => __('sale.sell_note')]); ?>
						...
						<div class="box box-solid bg-orange">
				            <div class="box-body">
				            	...
				            	<div class="col-md-12">
									...
									<?php if(!empty($change_return['amount'])): ?>
				            	...
				            	<div class="col-md-12">
				            		<hr>
				            		<strong>
				            			<?php echo app('translator')->get('sale.customer_wallet'); ?>:
				            		</strong>
				            		<br/>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-danger" id="add_to_customer_wallet"><?php echo app('translator')->get('sale.add_to_customer_wallet'); ?></button>
...
</div><?php /**PATH /home/vimi31/public_html/resources/views/sale_pos/partials/payment_modal.blade.php ENDPATH**/ ?>