<?php $__env->startSection('title', __('mpcs::lang.F17_form')); ?>
            ...
            <div class="settlement_tabs">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#f17_from_tab" class="f17_from_tab" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i> <strong><?php echo app('translator')->get('mpcs::lang.f17_from'); ?></strong>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#list_f17_from_tab" class="list_f17_from_tab" style="" data-toggle="tab">
                            <i class="fa fa-list"></i> <strong>
                                <?php echo app('translator')->get('mpcs::lang.list_f17_from'); ?> </strong>
                        </a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="f17_from_tab">
                        <?php echo $__env->make('mpcs::forms.F17.partials.f17_from', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>

                    <div class="tab-pane" id="list_f17_from_tab">
                        <?php echo $__env->make('mpcs::forms.F17.partials.list_f17_from', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if(result.success == 0){
                        ...
                        window.location.href = '<?php echo e(URL::to('/'), false); ?>/mpcs/F17';
                    }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/Modules/MPCS/Providers/../Resources/views/forms/F17/index.blade.php ENDPATH**/ ?>