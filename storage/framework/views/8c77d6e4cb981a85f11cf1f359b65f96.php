...
<?php $__env->startSection('title', __('mpcs::lang.14_form')); ?>
...
<section class="content">
    <div class="page-title-area" id="app">
        <section class="content">
        <?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'title' => __('mpcs::lang.F14_form')]); ?>
        <div class="col-md-3" id="location_filter">
            <div class="form-group">
                <?php echo Form::label('f14b_location_id', __('purchase.business_location') . ':'); ?>
                            ...
                            <div class="col-md-6 col-sm-6  col-xl-4 border">
                                <div class="col-md-12 " style="border: 1px solid #333; padding : 10px !important; margin-bottom: 10px !important">
                                    <div class="row">
                                        ...
                                        <b><?php echo app('translator')->get('mpcs::lang.filling_station'); ?></b><br>
                                        <b><?php echo app('translator')->get('mpcs::lang.tel'); ?> :</b> {{ sale.tel }}
                                        </div>
                                    ...
                                    <table class="table table-bordered table-striped credit_sale_table" style="width:100%;">
                                        <thead>
                                            <tr>
                                                <th><?php echo app('translator')->get('mpcs::lang.voucher_no'); ?></th>
                                                <th><?php echo app('translator')->get('mpcs::lang.balance_qty'); ?></th>
                                                <th><?php echo app('translator')->get('mpcs::lang.description'); ?></th>
                                                <th><?php echo app('translator')->get('mpcs::lang.unit_price'); ?></th>
                                                <th><?php echo app('translator')->get('mpcs::lang.amount'); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="4" class="text-center"><?php echo app('translator')->get('mpcs::lang.total_amount'); ?></td>
                                                <td>{{ parseFloat(sale.final_total).toFixed(sale.currency_precision) }} </td>
                                            </tr>
                                        </tfoot>
                                    </table>
    ...
    new Vue({
        ...
        data() {
            return {
                ...
                filter: {business_location_id:"<?php echo e($default_business_location, false); ?>",date_range:'',form_no:<?php echo e($setting['F14_form_sn'], false); ?>},
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vimi31/public_html/Modules/MPCS/Providers/../Resources/views/forms/F14.blade.php ENDPATH**/ ?>