            ...
            <div class="box-tools">
                ...
                <button class="btn btn-primary print_report pull-right" id="print_div">
                    ...
                    <table width="100%" style="margin-top: 10px;" class="no-border-table">
                                <tr style="border: none;">
                                    <td align="right" width="40%" style="border: none;">    </td>
                                    <td align="left" width="35%" style="border: none;"><h3>{{$business_location_name}}</h3></td>
                                    
                                    <td align="center" width="20%" style="border: none;"><h3>Form No:{{$form_9a_no}}<h3></td>
                                   ...
                                   <table class="table table-bordered table-striped" id="form_9ccr_table">
                                        <thead class="align-middle">
                                            <tr class="align-middle text-center">
                                                <th class="align-middle text-center" rowspan="2">@lang('mpcs::lang.bill_no')</th>
                                                <th class="align-middle text-center" rowspan="2">@lang('mpcs::lang.product_name')</th>
                                                <th class="align-middle text-center" rowspan="2">@lang('mpcs::lang.qty')</th>
                                                <th class="align-middle text-center" rowspan="2">@lang('mpcs::lang.page')</th>
