<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\Fleet\Http\Controllers\TripCategoryController@update', $fuel->id), 'method' =>
    'put', 'id' => 'trip_category_edit_form' ]) !!}
    ...
    <div class="modal-body">
      <div class="row">
        <div class="form-group col-sm-12">
          ...
          {!! Form::text('date', @format_datetime($fuel->date), ['class' => 'form-control', 'disabled', 'placeholder' => __(
          'fleet::lang.date' )]); !!}
        </div>
        <div class="form-group col-sm-12">
          {!! Form::label('name', __( 'fleet::lang.trip_category_name' ) . ':*') !!}
          {!! Form::text('name', $fuel->name, ['class' => 'form-control', 'placeholder' => __( 'fleet::lang.trip_category_name'), 'id'
          => 'trip_category_name']); !!}
        </div>
        <div class="form-group col-sm-12">
